...
function $3ef42575df84b30b$export$9d1611c77c2fe928(...args) {
  ...
  for (let i18 = 1; i18 < args.length; i18++) {
    ...
    for (let key in props) {
      ...
      90)
        result[key] = (0, $ff5963eb1fccf552$export$e08e3b67e392101e)(a27, b11);
      else if ((key === "className" || key === "UNSAFE_className") && typeof a27 === "string" && typeof b11 === "string")
        result[key] = (0, clsx_default)(a27, b11);
      else if (key === "id" && a27 && b11)
        result.id = (0, $bdb11010cef70236$export$cd8c9cb68f842629)(a27, b11);
      else
        result[key] = b11 !== void 0 ? b11 : a27;
    }
  }
  return result;
}
      ...
      return () => {
        cleanups.forEach((cleanup2, i18) => {
          if (typeof cleanup2 === "function")
            ...
            $5dc95899b306f630$var$setRef(refs[i18], null);
        });
      };
  };
}
  ...
  let pressProps = (0, import_react25.useMemo)(() => {
    ...
    let onKeyUp = (e8) => {
      ...
      if (state.isPressed && state.target && $f6c31cce2adf654f$var$isValidKeyboardEvent(e8, state.target)) {
        ...
        if (wasPressed)
          triggerSyntheticClick(e8, state.target);
        removeAllGlobalListeners();
    ...
    if (typeof PointerEvent !== "undefined") {
      ...
      pressProps2.onPointerUp = (e8) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e8.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e8.nativeEvent)) || state.pointerType === "virtual")
          return;
        if (e8.button === 0 && !state.isPressed)
      ...
      pressProps2.onMouseUp = (e8) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e8.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e8.nativeEvent)))
          return;
        if (!state.ignoreEmulatedMouseEvents && e8.button === 0 && !state.isPressed)
...
function o3() {
  let s17 = [], r20 = { addEventListener(e8, t13, n17, i18) {
    ...
    return s17.includes(e8) || s17.push(e8), () => {
      ...
      if (t13 >= 0)
        for (let n17 of s17.splice(t13, 1))
          n17();
    };
  }, dispose() {
    for (let e8 of s17.splice(0))
      e8();
  } };
  return r20;
}
...
function w({ disabled: e8 = false } = {}) {
  ...
  return { pressed: n17, pressProps: e8 ? {} : { onPointerDown: f24, onPointerUp: o22, onClick: o22 } };
}
...
function C({ ourProps: n17, theirProps: r20, slot: e8, defaultTag: a27, features: s17, visible: t13 = true, name: l16, mergeRefs: i18 }) {
  ...
  if (y11 & 2) {
    let { static: f24 = false, ...u24 } = o22;
    if (f24)
      return F(u24, e8, a27, l16, i18);
  }
  if (y11 & 1) {
    let { unmount: f24 = true, ...u24 } = o22;
    return u(f24 ? 0 : 1, { [0]() {
      return null;
    }, [1]() {
...
function F(n17, r20 = {}, e8, a27, s17) {
  let { as: t13 = e8, children: l16, refName: i18 = "ref", ...o22 } = h(n17, ["unmount", "static"]), y11 = n17.ref !== void 0 ? { [i18]: n17.ref } : {}, f24 = typeof l16 == "function" ? l16(r20) : l16;
  ...
  if (r20) {
    let d14 = false, p12 = [];
    for (let [c18, T15] of Object.entries(r20))
      typeof T15 == "boolean" && (d14 = true), T15 === true && p12.push(c18.replace(/([A-Z])/g, (g8) => `-${g8.toLowerCase()}`));
    if (d14) {
  ...
  if (t13 === import_react47.Fragment && (Object.keys(m2(o22)).length > 0 || Object.keys(m2(u24)).length > 0))
    if (!(0, import_react47.isValidElement)(f24) || Array.isArray(f24) && f24.length > 1) {
      if (Object.keys(m2(o22)).length > 0)
        throw new Error(['Passing props on "Fragment"!', "", `The current component <${a27} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(m2(o22)).concat(Object.keys(m2(u24))).map((d14) => `  - ${d14}`).join(`
...
`));
      ...
      let d14 = f24.props, p12 = d14 == null ? void 0 : d14.className, c18 = typeof p12 == "function" ? (...R6) => t3(p12(...R6), o22.className) : t3(p12, o22.className), T15 = c18 ? { className: c18 } : {}, g8 = P2(f24.props, m2(h(o22, ["ref"])));
      for (let R6 in u24)
        R6 in g8 && delete u24[R6];
      return (0, import_react47.cloneElement)(f24, Object.assign({}, g8, u24, y11, { ref: s17(H(f24), y11.ref) }, T15));
    }
  return (0, import_react47.createElement)(t13, Object.assign({}, h(o22, ["ref"]), t13 !== import_react47.Fragment && y11, t13 !== import_react47.Fragment && u24), f24);
}
function U() {
  let n17 = (0, import_react47.useRef)([]), r20 = (0, import_react47.useCallback)((e8) => {
    for (let a27 of n17.current)
      a27 != null && (typeof a27 == "function" ? a27(e8) : a27.current = e8);
  }, []);
  return (...e8) => {
    if (!e8.every((a27) => a27 == null))
      return n17.current = e8, r20;
  };
}
function $(...n17) {
  return n17.every((r20) => r20 == null) ? void 0 : (r20) => {
    for (let e8 of n17)
      e8 != null && (typeof e8 == "function" ? e8(r20) : e8.current = r20);
  };
}
function P2(...n17) {
  var a27;
  ...
  for (let s17 of n17)
    for (let t13 in s17)
      t13.startsWith("on") && typeof s17[t13] == "function" ? ((a27 = e8[t13]) != null || (e8[t13] = []), e8[t13].push(s17[t13])) : r20[t13] = s17[t13];
  if (r20.disabled || r20["aria-disabled"])
    for (let s17 in e8)
      /^(on(?:Click|Pointer|Mouse|Key)(?:Down|Up|Press)?)$/.test(s17) && (e8[s17] = [(t13) => {
        var l16;
        return (l16 = t13 == null ? void 0 : t13.preventDefault) == null ? void 0 : l16.call(t13);
      }]);
  for (let s17 in e8)
    Object.assign(r20, { [s17](t13, ...l16) {
      let i18 = e8[s17];
      for (let o22 of i18) {
        if ((t13 instanceof Event || (t13 == null ? void 0 : t13.nativeEvent) instanceof Event) && t13.defaultPrevented)
          return;
        o22(t13, ...l16);
      }
    } });
...
function m2(n17) {
  ...
  for (let e8 in r20)
    r20[e8] === void 0 && delete r20[e8];
  return r20;
}
function h(n17, r20 = []) {
  let e8 = Object.assign({}, n17);
  for (let a27 of r20)
    a27 in e8 && delete e8[a27];
  return e8;
}
function H(n17) {
...
function v2(a27, u24) {
  var p12;
  let l16 = a3(), { disabled: e8 = l16 || false, autoFocus: t13 = false, ...o22 } = a27, { isFocusVisible: r20, focusProps: i18 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: t13 }), { isHovered: s17, hoverProps: T15 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e8 }), { pressed: n17, pressProps: d14 } = w({ disabled: e8 }), f24 = _({ ref: u24, type: (p12 = o22.type) != null ? p12 : "button", disabled: e8 || void 0, autoFocus: t13 }, i18, T15, d14), m11 = (0, import_react48.useMemo)(() => ({ disabled: e8, hover: s17, focus: r20, active: n17, autofocus: t13 }), [e8, s17, r20, n17, t13]);
  return L()({ ourProps: f24, theirProps: o22, slot: m11, defaultTag: R, name: "Button" });
}
var H2 = K(v2);
...
function e2(i18 = {}, s17 = null, t13 = []) {
  for (let [r20, n17] of Object.entries(i18))
    o7(t13, f3(s17, r20), n17);
  return t13;
}
function f3(i18, s17) {
...
function o7(i18, s17, t13) {
  if (Array.isArray(t13))
    for (let [r20, n17] of t13.entries())
      o7(i18, f3(s17, r20.toString()), n17);
  else
    t13 instanceof Date ? i18.push([s17, t13.toISOString()]) : typeof t13 == "boolean" ? i18.push([s17, t13 ? "1" : "0"]) : typeof t13 == "string" ? i18.push([s17, t13]) : typeof t13 == "number" ? i18.push([s17, `${t13}`]) : t13 == null ? i18.push([s17, ""]) : e2(t13, s17, i18);
}
function p2(i18) {
  var t13, r20;
  let s17 = (t13 = i18 == null ? void 0 : i18.form) != null ? t13 : i18.closest("form");
  if (s17) {
    for (let n17 of s17.elements)
      if (n17 !== i18 && (n17.tagName === "INPUT" && n17.type === "submit" || n17.tagName === "BUTTON" && n17.type === "submit" || n17.nodeName === "INPUT" && n17.type === "image")) {
        n17.click();
        return;
      }
...
function l3(t13, r20) {
  var n17;
  let { features: d14 = 1, ...e8 } = t13, o22 = { ref: r20, "aria-hidden": (d14 & 2) === 2 ? true : (n17 = e8["aria-hidden"]) != null ? n17 : void 0, hidden: (d14 & 4) === 4 ? true : void 0, style: { position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0", ...(d14 & 4) === 4 && (d14 & 2) !== 2 && { display: "none" } } };
...
function c2({ children: t13 }) {
  ...
  if (!e8)
    return import_react52.default.createElement(import_react52.default.Fragment, null, t13);
  let { target: r20 } = e8;
...
function j2({ data: t13, form: e8, disabled: r20, onReset: n17, overrides: F12 }) {
  ...
  return (0, import_react52.useEffect)(() => {
    if (n17 && i18)
      return p12.addEventListener(i18, "reset", n17);
  }, [i18, e8, n17]), import_react52.default.createElement(c2, null, import_react52.default.createElement(C2, { setForm: a27, formId: e8 }), e2(t13).map(([s17, v6]) => import_react52.default.createElement(f4, { features: s4.Hidden, ...m2({ key: s17, as: "input", type: "hidden", hidden: true, readOnly: true, form: e8, disabled: r20, name: s17, value: v6, ...F12 }) })));
}
...
function s5(l16) {
  ...
  for (; e8 && !a5(e8); )
    E4(e8) && (t13 = e8), e8 = e8.parentElement;
...
function y(...t13) {
  ...
  let c18 = o5((e8) => {
    for (let o22 of n17.current)
      o22 != null && (typeof o22 == "function" ? o22(e8) : o22.current = e8);
  });
...
function w3() {
  ...
  return [r20.length > 0 ? r20.join(" ") : void 0, (0, import_react55.useMemo)(() => function(t13) {
    let i18 = o5((n17) => (e8((s17) => [...s17, n17]), () => e8((s17) => {
      let o22 = s17.slice(), p12 = o22.indexOf(n17);
      return p12 !== -1 && o22.splice(p12, 1), o22;
...
function C3(r20, e8) {
  ...
  let o22 = t13 || false, p12 = (0, import_react55.useMemo)(() => ({ ...n17.slot, disabled: o22 }), [n17.slot, o22]), D8 = { ref: s17, ...n17.props, id: i18 };
...
function U3(n17, l16) {
  var E16;
  let a27 = (0, import_react51.useId)(), e8 = C4(), o22 = u4(), y11 = a3(), { id: t13 = `headlessui-label-${a27}`, htmlFor: p12 = o22 != null ? o22 : (E16 = e8.props) == null ? void 0 : E16.htmlFor, passive: b11 = false, ...i18 } = n17, u24 = y(l16);
  ...
  }), f24 = y11 || false, R6 = (0, import_react56.useMemo)(() => ({ ...e8.slot, disabled: f24 }), [e8.slot, f24]), c18 = { ref: u24, ...e8.props, id: t13, htmlFor: p12, onClick: d14 };
  return b11 && ("onClick" in c18 && (delete c18.htmlFor, delete c18.onClick), "onClick" in i18 && delete i18.onClick), L()({ ourProps: c18, theirProps: i18, slot: R6, defaultTag: p12 ? G : "div", name: e8.name || "Label" });
}
var j3 = K(U3);
...
var de = "span";
function pe(T15, h11) {
  let C13 = (0, import_react51.useId)(), k8 = u4(), x13 = a3(), { id: g8 = k8 || `headlessui-checkbox-${C13}`, disabled: e8 = x13 || false, autoFocus: s17 = false, checked: E16, defaultChecked: v6, onChange: P7, name: d14, value: D8, form: R6, indeterminate: n17 = false, tabIndex: A6 = 0, ...F12 } = T15, r20 = l2(v6), [a27, t13] = T(E16, P7, r20 != null ? r20 : false), K6 = N(), _10 = U2(), H13 = p(), [p12, c18] = (0, import_react57.useState)(false), u24 = o5(() => {
    c18(true), t13 == null || t13(!a27), H13.nextFrame(() => {
      c18(false);
    });
  }), B4 = o5((o22) => {
    if (s5(o22.currentTarget))
      return o22.preventDefault();
    o22.preventDefault(), u24();
  }), I8 = o5((o22) => {
    o22.key === o10.Space ? (o22.preventDefault(), u24()) : o22.key === o10.Enter && p2(o22.currentTarget);
  }), L9 = o5((o22) => o22.preventDefault()), { isFocusVisible: m11, focusProps: M9 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: s17 }), { isHovered: b11, hoverProps: U6 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e8 }), { pressed: f24, pressProps: O8 } = w({ disabled: e8 }), X4 = _({ ref: h11, id: g8, role: "checkbox", "aria-checked": n17 ? "mixed" : a27 ? "true" : "false", "aria-labelledby": K6, "aria-describedby": _10, "aria-disabled": e8 ? true : void 0, indeterminate: n17 ? "true" : void 0, tabIndex: e8 ? void 0 : A6, onKeyUp: e8 ? void 0 : I8, onKeyPress: e8 ? void 0 : L9, onClick: e8 ? void 0 : B4 }, M9, U6, O8), G6 = (0, import_react57.useMemo)(() => ({ checked: a27, disabled: e8, hover: b11, focus: m11, active: f24, indeterminate: n17, changing: p12, autofocus: s17 }), [a27, n17, e8, b11, m11, f24, p12, s17]), S10 = (0, import_react57.useCallback)(() => {
    if (r20 !== void 0)
      return t13 == null ? void 0 : t13(r20);
  }, [t13, r20]), W2 = L();
  return import_react57.default.createElement(import_react57.default.Fragment, null, d14 != null && import_react57.default.createElement(j2, { disabled: e8, data: { [d14]: D8 || "on" }, overrides: { type: "checkbox", checked: a27 }, form: R6, onReset: S10 }), W2({ ourProps: X4, theirProps: F12, slot: G6, defaultTag: de, name: "Checkbox" }));
}
var Fe = K(pe);
  ...
  constructor(opts) {
    ...
    this.getVirtualItems = memo(
      ...
      (indexes, measurements) => {
        const virtualItems = [];
        for (let k8 = 0, len = indexes.length; k8 < len; k8++) {
          const i18 = indexes[k8];
...
var E5 = class {
  ...
  send(e8) {
    ...
    if (r20 !== n8(this, i8)) {
      ...
      for (let s17 of n8(this, a8).get(e8.type))
        s17(n8(this, i8), e8);
    }
  }
};
...
function d4(t13, e8) {
  do {
    ...
    if (r20.done && s17.done)
      return true;
    if (r20.done || s17.done || !Object.is(r20.value, s17.value))
      return false;
  } while (true);
}
function y3(t13) {
  if (Object.prototype.toString.call(t13) !== "[object Object]")
    return false;
...
function I(o22, s17) {
  ...
  return n(() => {
    if (o22)
      return r20.actions.push(t13), () => r20.actions.pop(t13);
...
function m6(t13) {
  ...
  if (r20 === 1 ? u12.delete(t13) : u12.set(t13, r20 - 1), r20 !== 1)
    return;
  let e8 = f10.get(t13);
...
function y5(t13, { allowed: r20, disallowed: e8 } = {}) {
  ...
  n(() => {
    ...
    if (!i18)
      return;
    let a27 = o3();
    for (let n17 of (d14 = e8 == null ? void 0 : e8()) != null ? d14 : [])
      n17 && a27.add(h4(n17));
    ...
    for (let n17 of s17) {
      ...
      for (; o22 && o22 !== l16.body; ) {
        for (let p12 of o22.children)
          s17.some((E16) => p12.contains(E16)) || a27.add(h4(p12));
...
function g2(e8, r20, { sorted: t13 = true, relativeTo: l16 = null, skipElements: o22 = [] } = {}) {
  ...
  let n17 = (() => {
    ...
    if (r20 & 1)
      return 0;
    if (r20 & 2)
      return Math.max(0, u24.indexOf(l16)) - 1;
    if (r20 & 4)
      return Math.max(0, u24.indexOf(l16)) + 1;
    if (r20 & 8)
      return u24.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), M9 = r20 & 32 ? { preventScroll: true } : {}, m11 = 0, d14 = u24.length, i18;
  do {
    if (m11 >= d14 || m11 + d14 <= 0)
      return 0;
    let s17 = x13 + m11;
    if (r20 & 16)
      s17 = (s17 + d14) % d14;
    ...
    i18 = u24[s17], i18 == null || i18.focus(M9), m11 += n17;
...
function k4(o22, f24, h11) {
  ...
  i10(o22, "touchstart", (t13) => {
    ...
    if (!(Math.abs(e8.x - l16.current.x) >= C6 || Math.abs(e8.y - l16.current.y) >= C6))
      return s17(t13, () => i4(t13.target) ? t13.target : null);
...
var H6 = ((t13) => (t13[t13.Ignore = 0] = "Ignore", t13[t13.Select = 1] = "Select", t13[t13.Close = 2] = "Close", t13))(H6 || {});
var L4 = { Ignore: { kind: 0 }, Select: (r20) => ({ kind: 1, target: r20 }), Close: { kind: 2 } };
var g3 = 200;
var d5 = 5;
function R2(r20, { trigger: n17, action: f24, close: t13, select: T15 }) {
  let l16 = (0, import_react68.useRef)(null), i18 = (0, import_react68.useRef)(null), u24 = (0, import_react68.useRef)(null);
  i10(r20 && n17 !== null, "pointerdown", (e8) => {
    o9(e8 == null ? void 0 : e8.target) && n17 != null && n17.contains(e8.target) && (i18.current = e8.x, u24.current = e8.y, l16.current = /* @__PURE__ */ new Date());
  }), i10(r20 && n17 !== null, "pointerup", (e8) => {
    var a27, s17;
    if (l16.current === null || !i4(e8.target) || Math.abs(e8.x - ((a27 = i18.current) != null ? a27 : e8.x)) < d5 && Math.abs(e8.y - ((s17 = u24.current) != null ? s17 : e8.y)) < d5)
      return;
    let c18 = f24(e8), M9 = (/* @__PURE__ */ new Date()).getTime() - l16.current.getTime();
    switch (l16.current = null, c18.kind) {
      case 0:
        return;
      case 1: {
        M9 > g3 && (T15(c18.target), t13());
        break;
      }
      case 2: {
        t13();
...
function f12(e8) {
  ...
  return E7(e8, "blur", (n17) => {
    ...
    if (document.activeElement !== e8 && l4(e8) && e8.isConnected) {
      if (e8.focus({ preventScroll: true }), e8.value !== l16.current.value)
...
function e5(t13, u24) {
  return (0, import_react71.useMemo)(() => {
    ...
    if (typeof r20 == "string" && r20.toLowerCase() === "button" || (u24 == null ? void 0 : u24.tagName) === "BUTTON" && !u24.hasAttribute("type"))
      return "button";
  }, [t13.type, t13.as, u24]);
}
  ...
  return t5() ? { before({ doc: n17, d: l16, meta: f24 }) {
    ...
    l16.microTask(() => {
      ...
      l16.addEventListener(n17, "click", (t13) => {
        ...
        if (i4(t13.target) && r4(t13.target))
          if (i18(t13.target)) {
            let e8 = t13.target;
            for (; e8.parentElement && i18(e8.parentElement); )
              e8 = e8.parentElement;
            l16.style(e8, "overscrollBehavior", "contain");
          } else
            l16.style(t13.target, "touchAction", "none");
...
var a14 = a13(() => /* @__PURE__ */ new Map(), { PUSH(e8, n17) {
  ...
  let o22 = { doc: e8, d: n17, meta: m7(t13) }, c18 = [w6(), d7(), r8()];
...
a14.subscribe(() => {
  ...
  for (let [t13] of e8)
    n17.set(t13, t13.documentElement.style.overflow);
...
function a15(r20, e8, n17 = () => ({ containers: [] })) {
  let f24 = o15(a14), o22 = e8 ? f24.get(e8) : void 0, i18 = o22 ? o22.count > 0 : false;
  return n(() => {
    if (!(!e8 || !r20))
      return a14.dispatch("PUSH", e8, n17), () => a14.dispatch("POP", e8, n17);
  }, [r20, e8]), i18;
}
...
function c6(u24 = 0) {
  let [t13, l16] = (0, import_react74.useState)(u24), g8 = (0, import_react74.useCallback)((e8) => l16(e8), [t13]), s17 = (0, import_react74.useCallback)((e8) => l16((a27) => a27 | e8), [t13]), m11 = (0, import_react74.useCallback)((e8) => (t13 & e8) === e8, [t13]), n17 = (0, import_react74.useCallback)((e8) => l16((a27) => a27 & ~e8), [l16]), F12 = (0, import_react74.useCallback)((e8) => l16((a27) => a27 ^ e8), [l16]);
  return { flags: t13, setFlag: g8, addFlag: s17, hasFlag: m11, removeFlag: n17, toggleFlag: F12 };
}
...
function R3(t13) {
  let n17 = {};
  for (let e8 in t13)
    t13[e8] === true && (n17[`data-${e8}`] = "");
  return n17;
}
function x4(t13, n17, e8, i18) {
  let [r20, o22] = (0, import_react75.useState)(e8), { hasFlag: s17, addFlag: a27, removeFlag: l16 } = c6(t13 && r20 ? 3 : 0), u24 = (0, import_react75.useRef)(false), f24 = (0, import_react75.useRef)(false), E16 = p();
  return n(() => {
    var d14;
    if (t13) {
      if (e8 && o22(true), !n17) {
      ...
      return (d14 = i18 == null ? void 0 : i18.start) == null || d14.call(i18, e8), C7(n17, { inFlight: u24, prepare() {
        ...
        var p12;
        f24.current && typeof n17.getAnimations == "function" && n17.getAnimations().length > 0 || (u24.current = false, l16(7), e8 || o22(false), (p12 = i18 == null ? void 0 : i18.end) == null || p12.call(i18, e8));
      } });
    }
  }, [t13, e8, n17, E16]), t13 ? [r20, { closed: s17(1), enter: s17(2), leave: s17(4), transition: s17(2) || s17(4) }] : [e8, { closed: void 0, enter: void 0, leave: void 0, transition: void 0 }];
}
...
function F3(c18, { container: e8, accept: t13, walk: r20 }) {
  ...
  (0, import_react76.useEffect)(() => {
    ...
    if (!n17)
      return;
    let f24 = o22.current, p12 = l16.current, i18 = Object.assign((m11) => f24(m11), { acceptNode: f24 }), u24 = n17.createTreeWalker(e8, NodeFilter.SHOW_ELEMENT, i18, false);
    for (; u24.nextNode(); )
      p12(u24.currentNode);
  }, [e8, c18, o22, l16]);
}
...
function m8(u24, t13) {
  ...
  (0, import_react77.useEffect)(() => {
    let o22 = [...e8.current];
    for (let [a27, l16] of t13.entries())
      if (e8.current[a27] !== l16) {
        let n17 = r20(t13, o22);
...
function Ae({ children: e8, enabled: t13 = true }) {
  let [n17, r20] = (0, import_react80.useState)(null), [l16, o22] = (0, import_react80.useState)(0), u24 = (0, import_react80.useRef)(null), [f24, s17] = (0, import_react80.useState)(null);
  ce(f24);
  let i18 = t13 && n17 !== null && f24 !== null, { to: F12 = "bottom", gap: E16 = 0, offset: A6 = 0, padding: c18 = 0, inner: h11 } = ge(n17, f24), [a27, p12 = "center"] = F12.split(" ");
  n(() => {
    i18 && o22(0);
  }, [i18]);
  let { refs: b11, floatingStyles: S10, context: g8 } = useFloating2({ open: i18, placement: a27 === "selection" ? p12 === "center" ? "bottom" : `bottom-${p12}` : p12 === "center" ? `${a27}` : `${a27}-${p12}`, strategy: "absolute", transform: false, middleware: [offset({ mainAxis: a27 === "selection" ? 0 : E16, crossAxis: A6 }), shift({ padding: c18 }), a27 !== "selection" && flip({ padding: c18 }), a27 === "selection" && h11 ? inner({ ...h11, padding: c18, overflowRef: u24, offset: l16, minItemsVisible: D2, referenceOverflowThreshold: c18, onFallbackChange(P7) {
    var L9, N2;
    if (!P7)
      return;
    ...
    for (let m11 of (N2 = (L9 = g8.elements.floating) == null ? void 0 : L9.childNodes) != null ? N2 : [])
      if (n4(m11)) {
        let x13 = m11.offsetTop, k8 = x13 + m11.clientHeight + M9, H13 = d14.scrollTop, U6 = H13 + d14.clientHeight;
        if (x13 >= H13 && k8 <= U6)
          I8--;
        else {
          B4 = Math.max(0, Math.min(k8, U6) - Math.max(x13, H13)), W2 = m11.clientHeight;
          break;
        }
      }
    I8 >= 1 && o22((m11) => {
      let x13 = W2 * I8 - B4 + M9;
      return m11 >= x13 ? m11 : x13;
    });
  ...
  } })].filter(Boolean), whileElementsMounted: autoUpdate }), [w13 = a27, V6 = p12] = g8.placement.split("-");
  a27 === "selection" && (w13 = "selection");
  let G6 = (0, import_react80.useMemo)(() => ({ anchor: [w13, V6].filter(Boolean).join(" ") }), [w13, V6]), K6 = useInnerOffset(g8, { overflowRef: u24, onChange: o22 }), { getReferenceProps: Q5, getFloatingProps: X4 } = useInteractions([K6]), Y3 = o5((P7) => {
    s17(P7), b11.setFloating(P7);
  });
  return j7.createElement($3.Provider, { value: r20 }, j7.createElement(y7.Provider, { value: { setFloating: Y3, setReference: b11.setReference, styles: S10, getReferenceProps: Q5, getFloatingProps: X4, slot: G6 } }, e8));
}
function ce(e8) {
  n(() => {
    if (!e8)
...
function ge(e8, t13) {
  var o22, u24, f24;
  let n17 = O3((o22 = e8 == null ? void 0 : e8.gap) != null ? o22 : "var(--anchor-gap, 0)", t13), r20 = O3((u24 = e8 == null ? void 0 : e8.offset) != null ? u24 : "var(--anchor-offset, 0)", t13), l16 = O3((f24 = e8 == null ? void 0 : e8.padding) != null ? f24 : "var(--anchor-padding, 0)", t13);
...
function O3(e8, t13, n17 = void 0) {
  let r20 = p(), l16 = o5((s17, i18) => {
    ...
    return [n17, null];
  }), o22 = (0, import_react80.useMemo)(() => l16(e8, t13)[0], [e8, t13]), [u24 = o22, f24] = (0, import_react80.useState)();
  return n(() => {
...
function f15({ children: o22, freeze: e8 }) {
  let n17 = l9(e8, o22);
...
t8(() => {
  function e8(t13) {
    if (!i4(t13.target) || t13.target === document.body || n13[0] === t13.target)
      return;
    let r20 = t13.target;
  ...
  switch (l16.focus) {
    case 0: {
      for (let e8 = 0; e8 < t13.length; ++e8)
        if (!n17.resolveDisabled(t13[e8], e8, t13))
          return e8;
      return r20;
    }
    case 1: {
      s17 === -1 && (s17 = t13.length);
      for (let e8 = s17 - 1; e8 >= 0; --e8)
        if (!n17.resolveDisabled(t13[e8], e8, t13))
          return e8;
      return r20;
    }
    case 2: {
      for (let e8 = s17 + 1; e8 < t13.length; ++e8)
        if (!n17.resolveDisabled(t13[e8], e8, t13))
          return e8;
      return r20;
    }
    case 3: {
      for (let e8 = t13.length - 1; e8 >= 0; --e8)
        if (!n17.resolveDisabled(t13[e8], e8, t13))
          return e8;
      return r20;
    }
    case 4: {
      for (let e8 = 0; e8 < t13.length; ++e8)
        if (n17.resolveId(t13[e8], e8, t13) === l16.id)
          return e8;
      return r20;
    }
    case 5:
...
function I3(e8) {
  let l16 = a16(), o22 = (0, import_react85.useContext)(H7), [r20, u24] = (0, import_react85.useState)(() => {
    var i18;
    if (!l16 && o22 !== null)
      return (i18 = o22.current) != null ? i18 : null;
    if (s.isServer)
      return null;
...
var D3 = K(function(l16, o22) {
  let { ownerDocument: r20 = null, ...u24 } = l16, t13 = (0, import_react85.useRef)(null), a27 = y(T2((s17) => {
    t13.current = s17;
  }), o22), i18 = n11(t13), f24 = r20 != null ? r20 : i18, p12 = I3(f24), [n17] = (0, import_react85.useState)(() => {
    var s17;
...
function J3(e8, l16) {
  ...
  return r20 ? import_react85.default.createElement(D3, { ...t13, ownerDocument: u24, ref: o22 }) : a27({ ourProps: { ref: o22 }, theirProps: t13, slot: {}, defaultTag: M2, name: "Portal" });
}
...
function oe() {
  let e8 = (0, import_react85.useContext)(g5), l16 = (0, import_react85.useRef)([]), o22 = o5((t13) => (l16.current.push(t13), e8 && e8.register(t13), () => r20(t13))), r20 = o5((t13) => {
...
var D4 = { [1](t13) {
  ...
  var i18, e8;
  if ((i18 = t13.dataRef.current) != null && i18.disabled || t13.comboboxState === 0)
    return t13;
  if ((e8 = t13.dataRef.current) != null && e8.value) {
    let n17 = t13.dataRef.current.calculateIndex(t13.dataRef.current.value);
    if (n17 !== -1)
      return { ...t13, activeOptionIndex: n17, comboboxState: 0, __demoMode: false };
  }
  ...
  var r20, u24, a27, d14;
  if ((r20 = t13.dataRef.current) != null && r20.disabled || t13.optionsElement && !((u24 = t13.dataRef.current) != null && u24.optionsPropsRef.current.static) && t13.comboboxState === 1)
    return t13;
  if (t13.virtual) {
    let { options: p12, disabled: s17 } = t13.virtual, b11 = i18.focus === c9.Specific ? i18.idx : f16(i18, { resolveItems: () => p12, resolveActiveIndex: () => {
      var v6, m11;
      return (m11 = (v6 = t13.activeOptionIndex) != null ? v6 : p12.findIndex((y11) => !s17(y11))) != null ? m11 : null;
  ...
  let n17 = i18.focus === c9.Specific ? i18.idx : f16(i18, { resolveItems: () => e8.options, resolveActiveIndex: () => e8.activeOptionIndex, resolveId: (p12) => p12.id, resolveDisabled: (p12) => p12.dataRef.current.disabled }), o22 = (d14 = i18.trigger) != null ? d14 : 2;
  ...
  var r20, u24, a27, d14;
  if ((r20 = t13.dataRef.current) != null && r20.virtual)
    return { ...t13, options: [...t13.options, i18.payload] };
  ...
  return (d14 = t13.dataRef.current) != null && d14.__demoMode && t13.dataRef.current.value === void 0 && (o22.activeOptionIndex = 0), o22;
}, [5]: (t13, i18) => {
  var n17;
  if ((n17 = t13.dataRef.current) != null && n17.virtual)
    return { ...t13, options: t13.options.filter((o22) => o22.id !== i18.id) };
  let e8 = T11(t13, (o22) => {
  ...
  var n17, o22;
  if (t13.virtual === null)
    return { ...t13, virtual: { options: i18.options, disabled: (n17 = i18.disabled) != null ? n17 : () => false } };
  if (t13.virtual.options === i18.options && t13.virtual.disabled === i18.disabled)
    return t13;
  ...
  constructor(e8) {
    ...
    c13(this, "actions", { onChange: (e9) => {
      ...
      return u(r20, { [0]: () => n17 == null ? void 0 : n17(e9), [1]: () => {
        let a27 = u24.slice(), d14 = a27.findIndex((p12) => o22(p12, e9));
    ...
    c13(this, "selectors", { activeDescendantId: (e9) => {
      ...
      if (n17 !== null)
        return e9.virtual ? (r20 = e9.options.find((u24) => !u24.dataRef.current.disabled && e9.dataRef.current.compare(u24.dataRef.current.value, e9.virtual.options[n17]))) == null ? void 0 : r20.id : (o22 = e9.options[n17]) == null ? void 0 : o22.id;
...
function vo(C13) {
  let h11 = p6("VirtualProvider"), e8 = ae2("VirtualProvider"), { options: o22 } = e8.virtual, A6 = S3(h11, (a27) => a27.optionsElement), [R6, v6] = (0, import_react87.useMemo)(() => {
    let a27 = A6;
    if (!a27)
      return [0, 0];
  ...
  }, [A6]), T15 = useVirtualizer({ enabled: o22.length !== 0, scrollPaddingStart: R6, scrollPaddingEnd: v6, count: o22.length, estimateSize() {
    return 40;
  }, getScrollElement() {
  ...
  return g8.length === 0 ? null : import_react87.default.createElement(Me.Provider, { value: T15 }, import_react87.default.createElement("div", { style: { position: "relative", width: "100%", height: `${T15.getTotalSize()}px` }, ref: (a27) => {
    a27 && (n17 || f24 !== null && o22.length > f24 && T15.scrollToIndex(f24));
  } }, g8.map((a27) => {
    var u24;
    return import_react87.default.createElement(import_react87.Fragment, { key: a27.key }, import_react87.default.cloneElement((u24 = C13.children) == null ? void 0 : u24.call(C13, { ...C13.slot, option: o22[a27.index] }), { key: `${I8}-${a27.key}`, "data-index": a27.index, "aria-setsize": o22.length, "aria-posinset": a27.index + 1, style: { position: "absolute", top: 0, left: 0, transform: `translateY(${a27.start}px)`, overflowAnchor: "none" } }));
  })));
}
var Po = import_react87.Fragment;
function Eo(C13, h11) {
  let e8 = (0, import_react51.useId)(), o22 = a3(), { value: A6, defaultValue: R6, onChange: v6, form: T15, name: I8, by: m11, invalid: g8 = false, disabled: n17 = o22 || false, onClose: f24, __demoMode: a27 = false, multiple: u24 = false, immediate: S10 = false, virtual: d14 = null, nullable: k8, ...W2 } = C13, y11 = l2(R6), [x13 = u24 ? [] : void 0, P7] = T(A6, v6, y11), b11 = b6({ id: e8, virtual: d14, __demoMode: a27 }), G6 = (0, import_react87.useRef)({ static: false, hold: false }), _10 = u9(m11), z5 = o5((s17) => d14 ? m11 === null ? d14.options.indexOf(s17) : d14.options.findIndex((c18) => _10(c18, s17)) : b11.state.options.findIndex((c18) => _10(c18.dataRef.current.value, s17))), U6 = (0, import_react87.useCallback)((s17) => u(r20.mode, { [M3.Multi]: () => x13.some((c18) => _10(c18, s17)), [M3.Single]: () => _10(x13, s17) }), [x13]), w13 = S3(b11, (s17) => s17.virtual), J7 = o5(() => f24 == null ? void 0 : f24()), r20 = (0, import_react87.useMemo)(() => ({ __demoMode: a27, immediate: S10, optionsPropsRef: G6, value: x13, defaultValue: y11, disabled: n17, invalid: g8, mode: u24 ? M3.Multi : M3.Single, virtual: d14 ? w13 : null, onChange: P7, isSelected: U6, calculateIndex: z5, compare: _10, onClose: J7 }), [x13, y11, n17, g8, u24, P7, U6, a27, b11, d14, w13, J7]);
  n(() => {
    var s17;
  ...
  let [M9, X4, i18, H13] = S3(b11, (s17) => [s17.comboboxState, s17.buttonElement, s17.inputElement, s17.optionsElement]), j10 = x3.get(null), q5 = S3(j10, (0, import_react87.useCallback)((s17) => j10.selectors.isTop(s17, e8), [j10, e8]));
  k4(q5, [X4, i18, H13], () => b11.actions.closeCombobox());
  let Q5 = S3(b11, b11.selectors.activeOptionIndex), $7 = S3(b11, b11.selectors.activeOption), be5 = (0, import_react87.useMemo)(() => ({ open: M9 === C8.Open, disabled: n17, invalid: g8, activeIndex: Q5, activeOption: $7, value: x13 }), [r20, n17, x13, g8, $7, M9]), [Y3, te4] = Q(), t13 = h11 === null ? {} : { ref: h11 }, B4 = (0, import_react87.useCallback)(() => {
    if (y11 !== void 0)
      return P7 == null ? void 0 : P7(y11);
  }, [P7, y11]), E16 = L();
  return import_react87.default.createElement(te4, { value: Y3, props: { htmlFor: i18 == null ? void 0 : i18.id }, slot: { open: M9 === C8.Open, disabled: n17 } }, import_react87.default.createElement(Ae, null, import_react87.default.createElement(de2.Provider, { value: r20 }, import_react87.default.createElement(u19.Provider, { value: b11 }, import_react87.default.createElement(c8, { value: u(M9, { [C8.Open]: i11.Open, [C8.Closed]: i11.Closed }) }, I8 != null && import_react87.default.createElement(j2, { disabled: n17, data: x13 != null ? { [I8]: x13 } : {}, form: T15, onReset: B4 }), E16({ ourProps: t13, theirProps: W2, slot: be5, defaultTag: Po, name: "Combobox" }))))));
}
var Oo = "input";
function ho(C13, h11) {
  var Y3, te4;
  let e8 = p6("Combobox.Input"), o22 = ae2("Combobox.Input"), A6 = (0, import_react51.useId)(), R6 = u4(), { id: v6 = R6 || `headlessui-combobox-input-${A6}`, onChange: T15, displayValue: I8, disabled: m11 = o22.disabled || false, autoFocus: g8 = false, type: n17 = "text", ...f24 } = C13, [a27] = S3(e8, (t13) => [t13.inputElement]), u24 = (0, import_react87.useRef)(null), S10 = y(u24, h11, Fe2(), e8.actions.setInputElement), d14 = n11(a27), [k8, W2] = S3(e8, (t13) => [t13.comboboxState, t13.isTyping]), y11 = p(), x13 = o5(() => {
  ...
  m8(([t13, B4], [E16, s17]) => {
    if (e8.state.isTyping)
      return;
    let c18 = u24.current;
    c18 && ((s17 === C8.Open && B4 === C8.Closed || t13 !== E16) && (c18.value = t13), requestAnimationFrame(() => {
      if (e8.state.isTyping || !c18 || (d14 == null ? void 0 : d14.activeElement) !== c18)
        return;
    ...
    if (t13 === C8.Open && B4 === C8.Closed) {
      ...
      if (!E16)
        return;
      let s17 = E16.value, { selectionStart: c18, selectionEnd: p12, selectionDirection: ne4 } = E16;
      E16.value = "", E16.value = s17, ne4 !== null ? E16.setSelectionRange(c18, p12, ne4) : E16.setSelectionRange(c18, p12);
    }
  }, [k8]);
  let b11 = (0, import_react87.useRef)(false), G6 = o5(() => {
    ...
    switch (e8.actions.setIsTyping(true), t13.key) {
      case o10.Enter:
        if (e8.state.comboboxState !== C8.Open || b11.current)
          return;
        if (t13.preventDefault(), t13.stopPropagation(), e8.selectors.activeOptionIndex(e8.state) === null) {
          e8.actions.closeCombobox();
          return;
        }
        e8.actions.selectActiveOption(), o22.mode === M3.Single && e8.actions.closeCombobox();
        break;
      case o10.ArrowDown:
      ...
      case o10.PageDown:
        return t13.preventDefault(), t13.stopPropagation(), e8.actions.goToOption({ focus: c9.Last });
      case o10.Escape:
        return e8.state.comboboxState !== C8.Open ? void 0 : (t13.preventDefault(), e8.state.optionsElement && !o22.optionsPropsRef.current.static && t13.stopPropagation(), o22.mode === M3.Single && o22.value === null && x13(), e8.actions.closeCombobox());
      case o10.Tab:
        if (e8.state.comboboxState !== C8.Open)
          return;
        o22.mode === M3.Single && e8.state.activationTrigger !== F4.Focus && e8.actions.selectActiveOption(), e8.actions.closeCombobox();
        break;
    }
  }), U6 = o5((t13) => {
    T15 == null || T15(t13), o22.mode === M3.Single && t13.target.value === "" && x13(), e8.actions.openCombobox();
  }), w13 = o5((t13) => {
    var E16, s17, c18;
    let B4 = (E16 = t13.relatedTarget) != null ? E16 : n13.find((p12) => p12 !== t13.currentTarget);
    if (!((s17 = e8.state.optionsElement) != null && s17.contains(B4)) && !((c18 = e8.state.buttonElement) != null && c18.contains(B4)) && e8.state.comboboxState === C8.Open)
      return t13.preventDefault(), o22.mode === M3.Single && o22.value === null && x13(), e8.actions.closeCombobox();
  }), J7 = o5((t13) => {
    var E16, s17, c18;
    let B4 = (E16 = t13.relatedTarget) != null ? E16 : n13.find((p12) => p12 !== t13.currentTarget);
  ...
  }), r20 = N(), M9 = U2(), { isFocused: X4, focusProps: i18 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: g8 }), { isHovered: H13, hoverProps: j10 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: m11 }), q5 = S3(e8, (t13) => t13.optionsElement), Q5 = (0, import_react87.useMemo)(() => ({ open: k8 === C8.Open, disabled: m11, invalid: o22.invalid, hover: H13, focus: X4, autofocus: g8 }), [o22, H13, X4, g8, m11, o22.invalid]), $7 = _({ ref: S10, id: v6, role: "combobox", type: n17, "aria-controls": q5 == null ? void 0 : q5.id, "aria-expanded": k8 === C8.Open, "aria-activedescendant": S3(e8, e8.selectors.activeDescendantId), "aria-labelledby": r20, "aria-describedby": M9, "aria-autocomplete": "list", defaultValue: (te4 = (Y3 = C13.defaultValue) != null ? Y3 : o22.defaultValue !== void 0 ? I8 == null ? void 0 : I8(o22.defaultValue) : null) != null ? te4 : o22.defaultValue, disabled: m11 || void 0, autoFocus: g8, onCompositionStart: G6, onCompositionEnd: _10, onKeyDown: z5, onChange: U6, onFocus: J7, onBlur: w13 }, i18, j10);
  return L()({ ourProps: $7, theirProps: f24, slot: Q5, defaultTag: Oo, name: "Combobox.Input" });
}
var Ao = "button";
function Io(C13, h11) {
  let e8 = p6("Combobox.Button"), o22 = ae2("Combobox.Button"), [A6, R6] = (0, import_react87.useState)(null), v6 = y(h11, R6, e8.actions.setButtonElement), T15 = (0, import_react51.useId)(), { id: I8 = `headlessui-combobox-button-${T15}`, disabled: m11 = o22.disabled || false, autoFocus: g8 = false, ...n17 } = C13, [f24, a27, u24] = S3(e8, (r20) => [r20.comboboxState, r20.inputElement, r20.optionsElement]), S10 = f12(a27), d14 = f24 === C8.Open;
  R2(d14, { trigger: A6, action: (0, import_react87.useCallback)((r20) => {
    if (A6 != null && A6.contains(r20.target))
      return L4.Ignore;
    if (a27 != null && a27.contains(r20.target))
      return L4.Ignore;
    let M9 = r20.target.closest('[role="option"]:not([data-disabled])');
    return n4(M9) ? L4.Select(M9) : u24 != null && u24.contains(r20.target) ? L4.Ignore : L4.Close;
  ...
  let k8 = o5((r20) => {
    switch (r20.key) {
      ...
      case o10.Escape:
        if (e8.state.comboboxState !== C8.Open)
          return;
        r20.preventDefault(), e8.state.optionsElement && !o22.optionsPropsRef.current.static && r20.stopPropagation(), (0, import_react_dom8.flushSync)(() => e8.actions.closeCombobox()), S10();
        return;
      default:
        return;
    }
  ...
  }), y11 = N([I8]), { isFocusVisible: x13, focusProps: P7 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: g8 }), { isHovered: b11, hoverProps: G6 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: m11 }), { pressed: _10, pressProps: z5 } = w({ disabled: m11 }), U6 = (0, import_react87.useMemo)(() => ({ open: f24 === C8.Open, active: _10 || f24 === C8.Open, disabled: m11, invalid: o22.invalid, value: o22.value, hover: b11, focus: x13 }), [o22, b11, x13, _10, m11, f24]), w13 = _({ ref: v6, id: I8, type: e5(C13, A6), tabIndex: -1, "aria-haspopup": "listbox", "aria-controls": u24 == null ? void 0 : u24.id, "aria-expanded": f24 === C8.Open, "aria-labelledby": y11, disabled: m11 || void 0, autoFocus: g8, onPointerDown: W2, onKeyDown: k8 }, P7, G6, z5);
  return L()({ ourProps: w13, theirProps: n17, slot: U6, defaultTag: Ao, name: "Combobox.Button" });
}
var Ro = "div";
var Do = O.RenderStrategy | O.Static;
function _o(C13, h11) {
  var E16, s17, c18;
  let e8 = (0, import_react51.useId)(), { id: o22 = `headlessui-combobox-options-${e8}`, hold: A6 = false, anchor: R6, portal: v6 = false, modal: T15 = true, transition: I8 = false, ...m11 } = C13, g8 = p6("Combobox.Options"), n17 = ae2("Combobox.Options"), f24 = ye(R6);
  f24 && (v6 = true);
  let [a27, u24] = Re(f24), [S10, d14] = (0, import_react87.useState)(null), k8 = Te(), W2 = y(h11, f24 ? a27 : null, g8.actions.setOptionsElement, d14), [y11, x13, P7, b11, G6] = S3(g8, (p12) => [p12.comboboxState, p12.inputElement, p12.buttonElement, p12.optionsElement, p12.activationTrigger]), _10 = n11(x13 || P7), z5 = n11(b11), U6 = u16(), [w13, J7] = x4(I8, S10, U6 !== null ? (U6 & i11.Open) === i11.Open : y11 === C8.Open);
  p5(w13, x13, g8.actions.closeCombobox);
  ...
  }), q5 = _(f24 ? k8() : {}, { "aria-labelledby": X4, role: "listbox", "aria-multiselectable": n17.mode === M3.Multi ? true : void 0, id: o22, ref: W2, style: { ...m11.style, ...u24, "--input-width": d3(x13, true).width, "--button-width": d3(P7, true).width }, onWheel: G6 === F4.Pointer ? void 0 : H13, onMouseDown: j10, ...R3(J7) }), Q5 = w13 && y11 === C8.Closed, $7 = l9(Q5, (E16 = n17.virtual) == null ? void 0 : E16.options), be5 = l9(Q5, n17.value), Y3 = o5((p12) => n17.compare(be5, p12)), te4 = (0, import_react87.useMemo)(() => {
    if (!n17.virtual)
      return n17;
    if ($7 === void 0)
  ...
  let t13 = L(), B4 = (0, import_react87.useMemo)(() => n17.mode === M3.Multi ? n17 : { ...n17, isSelected: Y3 }, [n17, Y3]);
  return import_react87.default.createElement(ne, { enabled: v6 ? C13.static || w13 : false, ownerDocument: _10 }, import_react87.default.createElement(de2.Provider, { value: B4 }, t13({ ourProps: q5, theirProps: { ...m11, children: import_react87.default.createElement(f15, { freeze: Q5 }, typeof m11.children == "function" ? (c18 = m11.children) == null ? void 0 : c18.call(m11, i18) : m11.children) }, slot: i18, defaultTag: Ro, features: Do, visible: w13, name: "Combobox.Options" })));
}
var Fo = "div";
function So(C13, h11) {
  var r20, M9, X4;
  let e8 = ae2("Combobox.Option"), o22 = p6("Combobox.Option"), A6 = (0, import_react51.useId)(), { id: R6 = `headlessui-combobox-option-${A6}`, value: v6, disabled: T15 = (X4 = (M9 = (r20 = e8.virtual) == null ? void 0 : r20.disabled) == null ? void 0 : M9.call(r20, v6)) != null ? X4 : false, order: I8 = null, ...m11 } = C13, [g8] = S3(o22, (i18) => [i18.inputElement]), n17 = f12(g8), f24 = S3(o22, (0, import_react87.useCallback)((i18) => o22.selectors.isActive(i18, v6, R6), [v6, R6])), a27 = e8.isSelected(v6), u24 = (0, import_react87.useRef)(null), S10 = s3({ disabled: T15, value: v6, domRef: u24, order: I8 }), d14 = (0, import_react87.useContext)(Me), k8 = y(h11, u24, d14 ? d14.measureElement : null), W2 = o5(() => {
    o22.actions.setIsTyping(false), o22.actions.onChange(v6);
  });
  n(() => o22.actions.registerOption(R6, S10), [S10, R6]);
  let y11 = S3(o22, (0, import_react87.useCallback)((i18) => o22.selectors.shouldScrollIntoView(i18, v6, R6), [v6, R6]));
  n(() => {
    if (y11)
  ...
  let x13 = o5((i18) => {
    i18.preventDefault(), i18.button === g4.Left && (T15 || (W2(), n10() || requestAnimationFrame(() => n17()), e8.mode === M3.Single && o22.actions.closeCombobox()));
  }), P7 = o5(() => {
    if (T15)
      return o22.actions.goToOption({ focus: c9.Nothing });
    let i18 = e8.calculateIndex(v6);
    o22.actions.goToOption({ focus: c9.Specific, idx: i18 });
  }), b11 = u14(), G6 = o5((i18) => b11.update(i18)), _10 = o5((i18) => {
    if (!b11.wasMoved(i18) || T15 || f24)
      return;
    let H13 = e8.calculateIndex(v6);
    o22.actions.goToOption({ focus: c9.Specific, idx: H13 }, F4.Pointer);
  }), z5 = o5((i18) => {
    b11.wasMoved(i18) && (T15 || f24 && (e8.optionsPropsRef.current.hold || o22.actions.goToOption({ focus: c9.Nothing })));
  }), U6 = (0, import_react87.useMemo)(() => ({ active: f24, focus: f24, selected: a27, disabled: T15 }), [f24, a27, T15]), w13 = { id: R6, ref: k8, role: "option", tabIndex: T15 === true ? void 0 : -1, "aria-disabled": T15 === true ? true : void 0, "aria-selected": a27, disabled: void 0, onMouseDown: x13, onFocus: P7, onPointerEnter: G6, onMouseEnter: G6, onPointerMove: _10, onMouseMove: _10, onPointerLeave: z5, onMouseLeave: z5 };
  return L()({ ourProps: w13, theirProps: m11, slot: U6, defaultTag: Fo, name: "Combobox.Option" });
}
var Mo = K(Eo);
var Lo = K(Io);
var Vo = K(ho);
...
var E10 = import_react88.Fragment;
function d10(o22, n17) {
  ...
  return L()({ ourProps: l16, theirProps: s17, slot: c18, defaultTag: E10, name: "DataInteractive" });
}
var x6 = K(d10);
...
function H8({ defaultContainers: r20 = [], portals: n17, mainTreeNode: o22 } = {}) {
  let l16 = n11(o22), u24 = o5(() => {
    ...
    let t13 = [];
    for (let e8 of r20)
      e8 !== null && (t4(e8) ? t13.push(e8) : "current" in e8 && t4(e8.current) && t13.push(e8.current));
    if (n17 != null && n17.current)
      for (let e8 of n17.current)
        t13.push(e8);
    for (let e8 of (i18 = l16 == null ? void 0 : l16.querySelectorAll("html > *, body > *")) != null ? i18 : [])
      e8 !== document.body && e8 !== document.head && t4(e8) && e8.id !== "headlessui-portal-root" && (o22 && (e8.contains(o22) || e8.contains((c18 = o22 == null ? void 0 : o22.getRootNode()) == null ? void 0 : c18.host)) || t13.some((d14) => e8.contains(d14)) || t13.push(e8));
    return t13;
  });
...
function P6({ children: r20, node: n17 }) {
  ...
  return import_react90.default.createElement(a19.Provider, { value: u24 }, r20, u24 === null && import_react90.default.createElement(f4, { features: s4.Hidden, ref: (t13) => {
    var i18, c18;
    if (t13) {
      for (let e8 of (c18 = (i18 = o2(t13)) == null ? void 0 : i18.querySelectorAll("html > *, body > *")) != null ? c18 : [])
        if (e8 !== document.body && e8 !== document.head && t4(e8) && e8 != null && e8.contains(t13)) {
          l16(e8);
          break;
        }
    }
...
function x7(s17) {
  ...
  for (let t13 of s17.current)
    t4(t13.current) && e8.add(t13.current);
  return e8;
}
var $4 = "div";
...
function D6(s17, e8) {
  let t13 = (0, import_react93.useRef)(null), r20 = y(t13, e8), { initialFocus: o22, initialFocusFallback: a27, containers: n17, features: u24 = 15, ...f24 } = s17;
  l11() || (u24 = 0);
  let l16 = n11(t13);
  ...
  let g8 = u20(), v6 = o5((c18) => {
    ...
    ((V6) => V6())(() => {
      u(g8.current, { [a20.Forwards]: () => {
        g2(E16, T5.First, { skipElements: [c18.relatedTarget, a27] });
      }, [a20.Backwards]: () => {
        g2(E16, T5.Last, { skipElements: [c18.relatedTarget, a27] });
      } });
    });
  }), A6 = I(!!(u24 & 2), "focus-trap#tab-lock"), N2 = p(), b11 = (0, import_react93.useRef)(false), k8 = { ref: r20, onKeyDown(c18) {
    ...
    if (!(u24 & 4))
      return;
    let E16 = x7(n17);
    n4(t13.current) && E16.add(t13.current);
    let L9 = c18.relatedTarget;
    i4(L9) && L9.dataset.headlessuiFocusGuard !== "true" && (I5(E16, L9) || (b11.current ? g2(t13.current, u(g8.current, { [a20.Forwards]: () => T5.Next, [a20.Backwards]: () => T5.Previous }) | T5.WrapAround, { relativeTo: c18.target }) : i4(c18.target) && I2(c18.target)));
  } }, B4 = L();
  return import_react93.default.createElement(import_react93.default.Fragment, null, A6 && import_react93.default.createElement(f4, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: v6, features: s4.Focusable }), B4({ ourProps: k8, theirProps: f24, defaultTag: $4, name: "FocusTrap" }), A6 && import_react93.default.createElement(f4, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: v6, features: s4.Focusable }));
}
var w7 = K(D6);
  ...
  return m8(() => {
    ...
    f24 && t(() => {
      ...
      if (r20 != null && r20.current)
        ...
        if (s17 & 16) {
          if (g2(f24, T5.First | T5.AutoFocus) !== y6.Error)
            return;
        } else if (g2(f24, T5.First) !== y6.Error)
          return;
        if (o22 != null && o22.current && (I2(o22.current), (e8 == null ? void 0 : e8.activeElement) === o22.current))
          return;
...
function ne2(s17, { ownerDocument: e8, container: t13, containers: r20, previousActiveElement: o22 }) {
  ...
  E7(e8 == null ? void 0 : e8.defaultView, "focus", (u24) => {
    if (!n17 || !a27.current)
      return;
    let f24 = x7(r20);
    ...
    if (!l16)
      return;
    let m11 = u24.target;
    n4(m11) ? I5(f24, m11) ? (o22.current = m11, I2(m11)) : (u24.preventDefault(), u24.stopPropagation(), I2(l16)) : I2(o22.current);
  }, true);
}
function I5(s17, e8) {
  for (let t13 of s17)
...
function Te2(e8, t13) {
  let n17 = s3(e8), l16 = (0, import_react94.useRef)([]), S10 = f19(), R6 = p(), d14 = o5((o22, i18 = A.Hidden) => {
    ...
    return i18 ? i18.state !== "visible" && (i18.state = "visible") : l16.current.push({ el: o22, state: "visible" }), () => d14(o22, A.Unmount);
  }), C13 = (0, import_react94.useRef)([]), p12 = (0, import_react94.useRef)(Promise.resolve()), h11 = (0, import_react94.useRef)({ enter: [], leave: [] }), g8 = o5((o22, i18, a27) => {
    C13.current.splice(0), t13 && (t13.chains.current[i18] = t13.chains.current[i18].filter(([s17]) => s17 !== o22)), t13 == null || t13.chains.current[i18].push([o22, new Promise((s17) => {
...
function Ae2(e8, t13) {
  var ee5, te4;
  let { transition: n17 = true, beforeEnter: l16, afterEnter: S10, beforeLeave: R6, afterLeave: d14, enter: y11, enterFrom: C13, enterTo: p12, entered: h11, leave: g8, leaveFrom: v6, leaveTo: o22, ...i18 } = e8, [a27, s17] = (0, import_react94.useState)(null), r20 = (0, import_react94.useRef)(null), f24 = ue2(e8), j10 = y(...f24 ? [r20, t13, s17] : t13 === null ? [] : [t13]), H13 = (ee5 = i18.unmount) == null || ee5 ? A.Unmount : A.Hidden, { show: u24, appear: z5, initial: K6 } = De(), [m11, G6] = (0, import_react94.useState)(u24 ? "visible" : "hidden"), Q5 = He(), { register: A6, unregister: I8 } = Q5;
  n(() => A6(r20), [A6, r20]), n(() => {
  ...
  let B4 = l11();
  n(() => {
    if (f24 && B4 && m11 === "visible" && r20.current === null)
      throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [r20, m11, B4, f24]);
  let ce3 = K6 && !z5, Y3 = z5 && u24 && K6, W2 = (0, import_react94.useRef)(false), L9 = Te2(() => {
    W2.current || (G6("hidden"), I8(r20));
  }, Q5), Z5 = o5((k8) => {
    W2.current = true;
    let F12 = k8 ? "enter" : "leave";
    L9.onStart(r20, F12, (_10) => {
      _10 === "enter" ? l16 == null || l16() : _10 === "leave" && (R6 == null || R6());
    });
  }), $7 = o5((k8) => {
    let F12 = k8 ? "enter" : "leave";
    W2.current = false, L9.onStop(r20, F12, (_10) => {
      _10 === "enter" ? S10 == null || S10() : _10 === "leave" && (d14 == null || d14());
    }), F12 === "leave" && !U4(L9) && (G6("hidden"), I8(r20));
  });
  (0, import_react94.useEffect)(() => {
    f24 && n17 || (Z5(u24), $7(u24));
  }, [u24, f24, n17]);
  let pe4 = (() => !(!n17 || !f24 || !B4 || ce3))(), [, T15] = x4(pe4, a27, u24, { start: Z5, end: $7 }), Ce4 = m2({ ref: j10, className: ((te4 = t3(i18.className, Y3 && y11, Y3 && C13, T15.enter && y11, T15.enter && T15.closed && C13, T15.enter && !T15.closed && p12, T15.leave && g8, T15.leave && !T15.closed && v6, T15.leave && T15.closed && o22, !T15.transition && u24 && h11)) == null ? void 0 : te4.trim()) || void 0, ...R3(T15) }), N2 = 0;
  m11 === "visible" && (N2 |= i11.Open), m11 === "hidden" && (N2 |= i11.Closed), u24 && m11 === "hidden" && (N2 |= i11.Opening), !u24 && m11 === "visible" && (N2 |= i11.Closing);
  let he3 = L();
  return import_react94.default.createElement(M5.Provider, { value: L9 }, import_react94.default.createElement(c8, { value: N2 }, he3({ ourProps: Ce4, theirProps: i18, defaultTag: de3, features: fe, visible: m11 === "visible", name: "Transition.Child" })));
}
function Ie(e8, t13) {
  let { show: n17, appear: l16 = false, unmount: S10 = true, ...R6 } = e8, d14 = (0, import_react94.useRef)(null), y11 = ue2(e8), C13 = y(...y11 ? [d14, t13] : t13 === null ? [] : [t13]);
  l11();
  let p12 = u16();
  if (n17 === void 0 && p12 !== null && (n17 = (p12 & i11.Open) === i11.Open), n17 === void 0)
  ...
  return import_react94.default.createElement(M5.Provider, { value: v6 }, import_react94.default.createElement(w8.Provider, { value: s17 }, H13({ ourProps: { ...r20, as: import_react94.Fragment, children: import_react94.default.createElement(me2, { ref: C13, ...r20, ...R6, beforeEnter: f24, beforeLeave: j10 }) }, theirProps: {}, defaultTag: import_react94.Fragment, features: fe, visible: h11 === "visible", name: "Transition" })));
}
function Le(e8, t13) {
...
var z = K(function(t13, o22) {
  let a27 = (0, import_react51.useId)(), { id: n17 = `headlessui-dialog-${a27}`, open: i18, onClose: s17, initialFocus: d14, role: p12 = "dialog", autoFocus: T15 = true, __demoMode: u24 = false, unmount: y11 = false, ...S10 } = t13, F12 = (0, import_react95.useRef)(false);
  p12 = function() {
    return p12 === "dialog" || p12 === "alertdialog" ? p12 : (F12.current || (F12.current = true, console.warn(`Invalid role [${p12}] passed to <Dialog />. Only \`dialog\` and and \`alertdialog\` are supported. Using \`dialog\` instead.`)), "dialog");
  }();
  let c18 = u16();
  i18 === void 0 && c18 !== null && (i18 = (c18 & i11.Open) === i11.Open);
  let f24 = (0, import_react95.useRef)(null), I8 = y(f24, o22), b11 = n11(f24), g8 = i18 ? 0 : 1, [v6, Q5] = (0, import_react95.useReducer)(Ue, { titleId: null, descriptionId: null, panelRef: (0, import_react95.createRef)() }), m11 = o5(() => s17(false)), B4 = o5((r20) => Q5({ type: 0, id: r20 })), D8 = l11() ? g8 === 0 : false, [Z5, ee5] = oe(), te4 = { get current() {
    var r20;
    return (r20 = v6.panelRef.current) != null ? r20 : f24.current;
  } }, L9 = y8(), { resolveContainers: M9 } = H8({ mainTreeNode: L9, portals: Z5, defaultContainers: [te4] }), U6 = c18 !== null ? (c18 & i11.Closing) === i11.Closing : false;
  y5(u24 || U6 ? false : D8, { allowed: o5(() => {
    var r20, W2;
    return [(W2 = (r20 = f24.current) == null ? void 0 : r20.closest("[data-headlessui-portal]")) != null ? W2 : null];
  }), disallowed: o5(() => {
    var r20;
    return [(r20 = L9 == null ? void 0 : L9.closest("body > *:not(#headlessui-portal-root)")) != null ? r20 : null];
  }) });
  let P7 = x3.get(null);
  n(() => {
    if (D8)
      return P7.actions.push(n17), () => P7.actions.pop(n17);
  }, [P7, n17, D8]);
  let H13 = S3(P7, (0, import_react95.useCallback)((r20) => P7.selectors.isTop(r20, n17), [P7, n17]));
  k4(H13, M9, (r20) => {
  ...
  }), f13(u24 || U6 ? false : D8, b11, M9), p5(D8, f24, m11);
  let [oe5, ne4] = w3(), re4 = (0, import_react95.useMemo)(() => [{ dialogState: g8, close: m11, setTitleId: B4, unmount: y11 }, v6], [g8, v6, m11, B4, y11]), N2 = (0, import_react95.useMemo)(() => ({ open: g8 === 0 }), [g8]), le2 = { ref: I8, id: n17, role: p12, tabIndex: -1, "aria-modal": u24 ? void 0 : g8 === 0 ? true : void 0, "aria-labelledby": v6.titleId, "aria-describedby": oe5, unmount: y11 }, ae4 = !f18(), E16 = G3.None;
  D8 && !u24 && (E16 |= G3.RestoreFocus, E16 |= G3.TabLock, T15 && (E16 |= G3.AutoFocus), ae4 && (E16 |= G3.InitialFocus));
  let ie4 = L();
  return import_react95.default.createElement(s9, null, import_react95.default.createElement(l12, { force: true }, import_react95.default.createElement(ne, null, import_react95.default.createElement(w9.Provider, { value: re4 }, import_react95.default.createElement(q2, { target: f24 }, import_react95.default.createElement(l12, { force: false }, import_react95.default.createElement(ne4, { slot: N2 }, import_react95.default.createElement(ee5, null, import_react95.default.createElement(Re2, { initialFocus: d14, initialFocusFallback: f24, containers: M9, features: E16 }, import_react95.default.createElement(C5, { value: m11 }, ie4({ ourProps: le2, theirProps: S10, slot: N2, defaultTag: He2, features: Ne, visible: g8 === 0, name: "Dialog" })))))))))));
});
var He2 = "div";
var Ne = O.RenderStrategy | O.Static;
function We(e8, t13) {
  let { transition: o22 = false, open: a27, ...n17 } = e8, i18 = u16(), s17 = e8.hasOwnProperty("open") || i18 !== null, d14 = e8.hasOwnProperty("onClose");
  if (!s17 && !d14)
...
var $e = "div";
function je(e8, t13) {
  let o22 = (0, import_react51.useId)(), { id: a27 = `headlessui-dialog-panel-${o22}`, transition: n17 = false, ...i18 } = e8, [{ dialogState: s17, unmount: d14 }, p12] = O6("Dialog.Panel"), T15 = y(t13, p12.panelRef), u24 = (0, import_react95.useMemo)(() => ({ open: s17 === 0 }), [s17]), y11 = o5((I8) => {
    I8.stopPropagation();
  }), S10 = { ref: T15, id: a27, onClick: y11 }, F12 = n17 ? Fe3 : import_react95.Fragment, c18 = n17 ? { unmount: d14 } : {}, f24 = L();
  return import_react95.default.createElement(F12, { ...c18 }, f24({ ourProps: S10, theirProps: i18, slot: u24, defaultTag: $e, name: "Dialog.Panel" }));
}
var Ye = "div";
function Je(e8, t13) {
  let { transition: o22 = false, ...a27 } = e8, [{ dialogState: n17, unmount: i18 }] = O6("Dialog.Backdrop"), s17 = (0, import_react95.useMemo)(() => ({ open: n17 === 0 }), [n17]), d14 = { ref: t13, "aria-hidden": true }, p12 = o22 ? Fe3 : import_react95.Fragment, T15 = o22 ? { unmount: i18 } : {}, u24 = L();
...
var Ke = "h2";
function Xe(e8, t13) {
  let o22 = (0, import_react51.useId)(), { id: a27 = `headlessui-dialog-title-${o22}`, ...n17 } = e8, [{ dialogState: i18, setTitleId: s17 }] = O6("Dialog.Title"), d14 = y(t13);
...
function Pe(e8, t13) {
  let { defaultOpen: l16 = false, ...p12 } = e8, a27 = (0, import_react97.useRef)(null), c18 = y(t13, T2((u24) => {
    a27.current = u24;
  }, e8.as === void 0 || e8.as === import_react97.Fragment)), n17 = (0, import_react97.useReducer)(De2, { disclosureState: l16 ? 0 : 1, buttonElement: null, panelElement: null, buttonId: null, panelId: null }), [{ disclosureState: o22, buttonId: r20 }, f24] = n17, s17 = o5((u24) => {
    f24({ type: 1 });
    let d14 = o2(a27);
    if (!d14 || !r20)
      return;
    ...
    T15 == null || T15.focus();
  }), E16 = (0, import_react97.useMemo)(() => ({ close: s17 }), [s17]), m11 = (0, import_react97.useMemo)(() => ({ open: o22 === 0, close: s17 }), [o22, s17]), D8 = { ref: c18 }, S10 = L();
  return import_react97.default.createElement(_7.Provider, { value: n17 }, import_react97.default.createElement(F7.Provider, { value: E16 }, import_react97.default.createElement(C5, { value: s17 }, import_react97.default.createElement(c8, { value: u(o22, { [0]: i11.Open, [1]: i11.Closed }) }, S10({ ourProps: D8, theirProps: p12, slot: m11, defaultTag: ye2, name: "Disclosure" })))));
}
var Ee2 = "button";
function Se(e8, t13) {
  let l16 = (0, import_react51.useId)(), { id: p12 = `headlessui-disclosure-button-${l16}`, disabled: a27 = false, autoFocus: c18 = false, ...n17 } = e8, [o22, r20] = M6("Disclosure.Button"), f24 = fe3(), s17 = f24 === null ? false : f24 === o22.panelId, E16 = (0, import_react97.useRef)(null), m11 = y(E16, t13, o5((i18) => {
    if (!s17)
      return r20({ type: 4, element: i18 });
  }));
  (0, import_react97.useEffect)(() => {
    if (!s17)
      return r20({ type: 2, buttonId: p12 }), () => {
  ...
  let D8 = o5((i18) => {
    var g8;
    if (s17) {
      if (o22.disclosureState === 1)
        return;
      switch (i18.key) {
        case o10.Space:
        case o10.Enter:
          i18.preventDefault(), i18.stopPropagation(), r20({ type: 0 }), (g8 = o22.buttonElement) == null || g8.focus();
          break;
      }
    } else
      switch (i18.key) {
    ...
    var g8;
    s5(i18.currentTarget) || a27 || (s17 ? (r20({ type: 0 }), (g8 = o22.buttonElement) == null || g8.focus()) : r20({ type: 0 }));
  }), { isFocusVisible: d14, focusProps: T15 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: c18 }), { isHovered: b11, hoverProps: h11 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: a27 }), { pressed: U6, pressProps: G6 } = w({ disabled: a27 }), X4 = (0, import_react97.useMemo)(() => ({ open: o22.disclosureState === 0, hover: b11, active: U6, disabled: a27, focus: d14, autofocus: c18 }), [o22, b11, U6, d14, a27, c18]), N2 = e5(e8, o22.buttonElement), q5 = s17 ? _({ ref: m11, type: N2, disabled: a27 || void 0, autoFocus: c18, onKeyDown: D8, onClick: u24 }, T15, h11, G6) : _({ ref: m11, id: p12, type: N2, "aria-expanded": o22.disclosureState === 0, "aria-controls": o22.panelElement ? o22.panelId : void 0, disabled: a27 || void 0, autoFocus: c18, onKeyDown: D8, onKeyUp: S10, onClick: u24 }, T15, h11, G6);
  return L()({ ourProps: q5, theirProps: n17, slot: X4, defaultTag: Ee2, name: "Disclosure.Button" });
}
var ge3 = "div";
var Ae3 = O.RenderStrategy | O.Static;
function be2(e8, t13) {
  let l16 = (0, import_react51.useId)(), { id: p12 = `headlessui-disclosure-panel-${l16}`, transition: a27 = false, ...c18 } = e8, [n17, o22] = M6("Disclosure.Panel"), { close: r20 } = J4("Disclosure.Panel"), [f24, s17] = (0, import_react97.useState)(null), E16 = y(t13, o5((b11) => {
    a21(() => o22({ type: 5, element: b11 }));
  }), s17);
  (0, import_react97.useEffect)(() => (o22({ type: 3, panelId: p12 }), () => {
    o22({ type: 3, panelId: null });
  }), [p12, o22]);
  let m11 = u16(), [D8, S10] = x4(a27, f24, m11 !== null ? (m11 & i11.Open) === i11.Open : n17.disclosureState === 0), u24 = (0, import_react97.useMemo)(() => ({ open: n17.disclosureState === 0, close: r20 }), [n17.disclosureState, r20]), d14 = { ref: E16, id: p12, ...R3(S10) }, T15 = L();
  return import_react97.default.createElement(s9, null, import_react97.default.createElement(H9.Provider, { value: n17.panelId }, T15({ ourProps: d14, theirProps: c18, slot: u24, defaultTag: ge3, features: Ae3, visible: D8, name: "Disclosure.Panel" })));
}
var Ce = K(Pe);
var Re3 = K(Se);
var Ie2 = K(be2);
...
function c15(d14, l16) {
  let t13 = `headlessui-control-${(0, import_react51.useId)()}`, [s17, p12] = Q(), [n17, a27] = w3(), m11 = a3(), { disabled: e8 = m11 || false, ...i18 } = d14, o22 = (0, import_react98.useMemo)(() => ({ disabled: e8 }), [e8]), F12 = { ref: l16, disabled: e8 || void 0, "aria-disabled": e8 || void 0 }, T15 = L();
  return import_react98.default.createElement(l, { value: e8 }, import_react98.default.createElement(p12, { value: s17 }, import_react98.default.createElement(a27, { value: n17 }, import_react98.default.createElement(f6, { id: t13 }, T15({ ourProps: F12, theirProps: { ...i18, children: import_react98.default.createElement(W, null, typeof i18.children == "function" ? i18.children(o22) : i18.children) }, slot: o22, defaultTag: _8, name: "Field" })))));
}
var H10 = K(c15);
...
function _9(t13, a27) {
  var s17;
  let i18 = a3(), { disabled: e8 = i18 || false, ...p12 } = t13, [n17, T15] = d11((s17 = t13.as) != null ? s17 : d12), l16 = y(a27, T15), [r20, f24] = Q(), m11 = (0, import_react100.useMemo)(() => ({ disabled: e8 }), [e8]), y11 = n17 === "fieldset" ? { ref: l16, "aria-labelledby": r20, disabled: e8 || void 0 } : { ref: l16, role: "group", "aria-labelledby": r20, "aria-disabled": e8 || void 0 }, F12 = L();
  return import_react100.default.createElement(l, { value: e8 }, import_react100.default.createElement(f24, null, F12({ ourProps: y11, theirProps: p12, slot: m11, defaultTag: d12, name: "Fieldset" })));
}
var G4 = K(_9);
...
var x9 = "input";
function h8(p12, s17) {
  let a27 = (0, import_react51.useId)(), l16 = u4(), i18 = a3(), { id: d14 = l16 || `headlessui-input-${a27}`, disabled: e8 = i18 || false, autoFocus: o22 = false, invalid: t13 = false, ...u24 } = p12, f24 = N(), m11 = U2(), { isFocused: r20, focusProps: T15 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: o22 }), { isHovered: n17, hoverProps: b11 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e8 }), y11 = _({ ref: s17, id: d14, "aria-labelledby": f24, "aria-describedby": m11, "aria-invalid": t13 ? "true" : void 0, disabled: e8 || void 0, autoFocus: o22 }, T15, b11), I8 = (0, import_react101.useMemo)(() => ({ disabled: e8, invalid: t13, hover: n17, focus: r20, autofocus: o22 }), [e8, t13, n17, r20, o22]);
...
function s12(n17, t13) {
  ...
  if (n(() => {
    ...
    r20 && (e8.current = r20);
  }, [n17, t13]), t13 == null || !n17 || t13 === document.activeElement)
    return false;
...
function o20(e8) {
  ...
  if (!n4(t13))
    return i18;
  let u24 = false;
  for (let f24 of t13.querySelectorAll('[hidden],[aria-hidden],[role="img"]'))
    f24.remove(), u24 = true;
...
var v5 = (e8, o22, t13) => (m10(e8, typeof o22 != "symbol" ? o22 + "" : o22, t13), t13);
...
var C10 = { [1](e8) {
  ...
  if (o22.focus === c9.Nothing)
    return { ...t13, activeOptionIndex: null };
  if (o22.focus === c9.Specific)
    return { ...t13, activeOptionIndex: e8.options.findIndex((r20) => r20.id === o22.id) };
  if (o22.focus === c9.Previous) {
    let r20 = e8.activeOptionIndex;
    if (r20 !== null) {
      let O8 = e8.options[r20].dataRef.current.domRef, f24 = f16(o22, { resolveItems: () => e8.options, resolveActiveIndex: () => e8.activeOptionIndex, resolveId: (c18) => c18.id, resolveDisabled: (c18) => c18.dataRef.current.disabled });
      if (f24 !== null) {
        let c18 = e8.options[f24].dataRef.current.domRef;
        if (((l16 = O8.current) == null ? void 0 : l16.previousElementSibling) === c18.current || ((u24 = c18.current) == null ? void 0 : u24.previousElementSibling) === null)
          return { ...t13, activeOptionIndex: f24 };
      }
    }
    ...
    if (r20 !== null) {
      ...
      if (f24 !== null) {
        let c18 = e8.options[f24].dataRef.current.domRef;
        if (((d14 = O8.current) == null ? void 0 : d14.nextElementSibling) === c18.current || ((a27 = c18.current) == null ? void 0 : a27.nextElementSibling) === null)
          return { ...t13, activeOptionIndex: f24 };
      }
    }
  }
  let n17 = b9(e8), i18 = f16(o22, { resolveItems: () => n17.options, resolveActiveIndex: () => n17.activeOptionIndex, resolveId: (r20) => r20.id, resolveDisabled: (r20) => r20.dataRef.current.disabled });
  return { ...t13, ...n17, activeOptionIndex: i18 };
}, [3]: (e8, o22) => {
  if (e8.dataRef.current.disabled || e8.listboxState === 1)
    return e8;
  let n17 = e8.searchQuery !== "" ? 0 : 1, i18 = e8.searchQuery + o22.value.toLowerCase(), l16 = (e8.activeOptionIndex !== null ? e8.options.slice(e8.activeOptionIndex + n17).concat(e8.options.slice(0, e8.activeOptionIndex + n17)) : e8.options).find((d14) => {
    var a27;
  ...
  for (let [s17, l16] of t13.entries())
    if (i18.has(l16.id) && (n17.push(s17), i18.delete(l16.id), i18.size === 0))
      break;
  if (n17.length > 0) {
    t13 = t13.slice();
    for (let s17 of n17.reverse())
      t13.splice(s17, 1);
  }
...
// node_modules/@headlessui/react/dist/components/listbox/listbox.js
var ie2 = (0, import_react106.createContext)(null);
ie2.displayName = "ListboxDataContext";
function Z3(g8) {
  let D8 = (0, import_react106.useContext)(ie2);
  if (D8 === null) {
    let O8 = new Error(`<${g8} /> is missing a parent <Listbox /> component.`);
    throw Error.captureStackTrace && Error.captureStackTrace(O8, Z3), O8;
  }
  return D8;
}
var Et = import_react106.Fragment;
function vt2(g8, D8) {
  let O8 = (0, import_react51.useId)(), u24 = a3(), { value: i18, defaultValue: l16, form: F12, name: s17, onChange: b11, by: n17, invalid: c18 = false, disabled: m11 = u24 || false, horizontal: a27 = false, multiple: t13 = false, __demoMode: p12 = false, ...S10 } = g8;
  const E16 = a27 ? "horizontal" : "vertical";
  let N2 = y(D8), C13 = l2(l16), [f24 = t13 ? [] : void 0, L9] = T(i18, b11, C13), y11 = u21({ id: O8, __demoMode: p12 }), I8 = (0, import_react106.useRef)({ static: false, hold: false }), U6 = (0, import_react106.useRef)(/* @__PURE__ */ new Map()), M9 = u9(n17), H13 = (0, import_react106.useCallback)((h11) => u(r20.mode, { [L7.Multi]: () => f24.some((j10) => M9(j10, h11)), [L7.Single]: () => M9(f24, h11) }), [f24]), r20 = (0, import_react106.useMemo)(() => ({ value: f24, disabled: m11, invalid: c18, mode: t13 ? L7.Multi : L7.Single, orientation: E16, onChange: L9, compare: M9, isSelected: H13, optionsPropsRef: I8, listRef: U6 }), [f24, m11, c18, t13, E16, L9, M9, H13, I8, U6]);
  n(() => {
    y11.state.dataRef.current = r20;
  }, [r20]);
  let P7 = S3(y11, (h11) => h11.listboxState), G6 = x3.get(null), W2 = S3(G6, (0, import_react106.useCallback)((h11) => G6.selectors.isTop(h11, O8), [G6, O8])), [v6, K6] = S3(y11, (h11) => [h11.buttonElement, h11.optionsElement]);
  k4(W2, [v6, K6], (h11, j10) => {
    y11.send({ type: M7.CloseListbox }), A2(j10, h5.Loose) || (h11.preventDefault(), v6 == null || v6.focus());
  });
  let X4 = (0, import_react106.useMemo)(() => ({ open: P7 === E12.Open, disabled: m11, invalid: c18, value: f24 }), [P7, m11, c18, f24]), [ee5, o22] = Q({ inherit: true }), R6 = { ref: N2 }, se2 = (0, import_react106.useCallback)(() => {
    if (C13 !== void 0)
      return L9 == null ? void 0 : L9(C13);
  }, [L9, C13]), te4 = L();
  return import_react106.default.createElement(o22, { value: ee5, props: { htmlFor: v6 == null ? void 0 : v6.id }, slot: { open: P7 === E12.Open, disabled: m11 } }, import_react106.default.createElement(Ae, null, import_react106.default.createElement(c16.Provider, { value: y11 }, import_react106.default.createElement(ie2.Provider, { value: r20 }, import_react106.default.createElement(c8, { value: u(P7, { [E12.Open]: i11.Open, [E12.Closed]: i11.Closed }) }, s17 != null && f24 != null && import_react106.default.createElement(j2, { disabled: m11, data: { [s17]: f24 }, form: F12, onReset: se2 }), te4({ ourProps: R6, theirProps: S10, slot: X4, defaultTag: Et, name: "Listbox" }))))));
}
var ht = "button";
function Dt(g8, D8) {
  let O8 = (0, import_react51.useId)(), u24 = u4(), i18 = Z3("Listbox.Button"), l16 = p9("Listbox.Button"), { id: F12 = u24 || `headlessui-listbox-button-${O8}`, disabled: s17 = i18.disabled || false, autoFocus: b11 = false, ...n17 } = g8, c18 = y(D8, Fe2(), l16.actions.setButtonElement), m11 = be(), [a27, t13, p12] = S3(l16, (o22) => [o22.listboxState, o22.buttonElement, o22.optionsElement]), S10 = a27 === E12.Open;
  R2(S10, { trigger: t13, action: (0, import_react106.useCallback)((o22) => {
    if (t13 != null && t13.contains(o22.target))
      return L4.Ignore;
    let R6 = o22.target.closest('[role="option"]:not([data-disabled])');
    return n4(R6) ? L4.Select(R6) : p12 != null && p12.contains(o22.target) ? L4.Ignore : L4.Close;
  }, [t13, p12]), close: l16.actions.closeListbox, select: l16.actions.selectActiveOption });
  let E16 = o5((o22) => {
    switch (o22.key) {
      case o10.Enter:
      ...
      case o10.Space:
      case o10.ArrowDown:
        o22.preventDefault(), l16.actions.openListbox({ focus: i18.value ? c9.Nothing : c9.First });
        break;
      case o10.ArrowUp:
        o22.preventDefault(), l16.actions.openListbox({ focus: i18.value ? c9.Nothing : c9.Last });
        break;
    }
  }), N2 = o5((o22) => {
    switch (o22.key) {
  ...
  }), C13 = (0, import_react106.useRef)(null), f24 = o5((o22) => {
    var R6;
    if (C13.current = o22.pointerType, o22.pointerType === "mouse" && o22.button === g4.Left) {
      if (s5(o22.currentTarget))
        return o22.preventDefault();
      l16.state.listboxState === E12.Open ? ((0, import_react_dom9.flushSync)(() => l16.actions.closeListbox()), (R6 = l16.state.buttonElement) == null || R6.focus({ preventScroll: true })) : (o22.preventDefault(), l16.actions.openListbox({ focus: c9.Nothing }));
    }
  }), L9 = o5((o22) => {
    var R6;
    if (C13.current !== "mouse" && o22.button === g4.Left) {
      if (s5(o22.currentTarget))
        return o22.preventDefault();
      l16.state.listboxState === E12.Open ? ((0, import_react_dom9.flushSync)(() => l16.actions.closeListbox()), (R6 = l16.state.buttonElement) == null || R6.focus({ preventScroll: true })) : (o22.preventDefault(), l16.actions.openListbox({ focus: c9.Nothing }));
    }
  }), y11 = o5((o22) => o22.preventDefault()), I8 = N([F12]), U6 = U2(), { isFocusVisible: M9, focusProps: H13 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: b11 }), { isHovered: r20, hoverProps: P7 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: s17 }), { pressed: G6, pressProps: W2 } = w({ disabled: s17 }), v6 = (0, import_react106.useMemo)(() => ({ open: a27 === E12.Open, active: G6 || a27 === E12.Open, disabled: s17, invalid: i18.invalid, value: i18.value, hover: r20, focus: M9, autofocus: b11 }), [a27, i18.value, s17, r20, M9, G6, i18.invalid, b11]), K6 = S3(l16, (o22) => o22.listboxState === E12.Open), X4 = _(m11(), { ref: c18, id: F12, type: e5(g8, t13), "aria-haspopup": "listbox", "aria-controls": p12 == null ? void 0 : p12.id, "aria-expanded": K6, "aria-labelledby": I8, "aria-describedby": U6, disabled: s17 || void 0, autoFocus: b11, onKeyDown: E16, onKeyUp: N2, onKeyPress: y11, onPointerDown: f24, onClick: L9 }, H13, P7, W2);
  return L()({ ourProps: X4, theirProps: n17, slot: v6, defaultTag: ht, name: "Listbox.Button" });
}
var ge4 = (0, import_react106.createContext)(false);
var St = "div";
var Rt = O.RenderStrategy | O.Static;
function At(g8, D8) {
  let O8 = (0, import_react51.useId)(), { id: u24 = `headlessui-listbox-options-${O8}`, anchor: i18, portal: l16 = false, modal: F12 = true, transition: s17 = false, ...b11 } = g8, n17 = ye(i18), [c18, m11] = (0, import_react106.useState)(null);
  n17 && (l16 = true);
  let a27 = Z3("Listbox.Options"), t13 = p9("Listbox.Options"), [p12, S10, E16, N2] = S3(t13, (e8) => [e8.listboxState, e8.buttonElement, e8.optionsElement, e8.__demoMode]), C13 = n11(S10), f24 = n11(E16), L9 = u16(), [y11, I8] = x4(s17, c18, L9 !== null ? (L9 & i11.Open) === i11.Open : p12 === E12.Open);
  p5(y11, S10, t13.actions.closeListbox);
  let U6 = N2 ? false : F12 && p12 === E12.Open;
  f13(U6, f24);
  let M9 = N2 ? false : F12 && p12 === E12.Open;
  y5(M9, { allowed: (0, import_react106.useCallback)(() => [S10, E16], [S10, E16]) });
  let H13 = p12 !== E12.Open, P7 = s12(H13, S10) ? false : y11, G6 = y11 && p12 === E12.Closed, W2 = l9(G6, a27.value), v6 = o5((e8) => a27.compare(W2, e8)), K6 = S3(t13, (e8) => {
    var J7;
    if (n17 == null || !((J7 = n17 == null ? void 0 : n17.to) != null && J7.includes("selection")))
      return null;
    let A6 = e8.options.findIndex((pe4) => v6(pe4.dataRef.current.value));
    return A6 === -1 && (A6 = 0), A6;
  }), X4 = (() => {
    if (n17 == null)
      return;
    if (K6 === null)
      return { ...n17, inner: void 0 };
    let e8 = Array.from(a27.listRef.current.values());
    return { ...n17, inner: { listRef: { current: e8 }, index: K6 } };
  })(), [ee5, o22] = Re(X4), R6 = Te(), se2 = y(D8, n17 ? ee5 : null, t13.actions.setOptionsElement, m11), te4 = p();
  (0, import_react106.useEffect)(() => {
    var A6;
    let e8 = E16;
    e8 && p12 === E12.Open && e8 !== ((A6 = o2(e8)) == null ? void 0 : A6.activeElement) && (e8 == null || e8.focus({ preventScroll: true }));
  }, [p12, E16]);
  let h11 = o5((e8) => {
    var A6, J7;
    switch (te4.dispose(), e8.key) {
      case o10.Space:
        if (t13.state.searchQuery !== "")
          return e8.preventDefault(), e8.stopPropagation(), t13.actions.search(e8.key);
      case o10.Enter:
        ...
        a27.mode === L7.Single && ((0, import_react_dom9.flushSync)(() => t13.actions.closeListbox()), (A6 = t13.state.buttonElement) == null || A6.focus({ preventScroll: true }));
        break;
      ...
      case o10.Escape:
        e8.preventDefault(), e8.stopPropagation(), (0, import_react_dom9.flushSync)(() => t13.actions.closeListbox()), (J7 = t13.state.buttonElement) == null || J7.focus({ preventScroll: true });
        return;
      case o10.Tab:
        ...
        break;
      default:
        e8.key.length === 1 && (t13.actions.search(e8.key), te4.setTimeout(() => t13.actions.clearSearch(), 350));
        break;
    }
  }), j10 = S3(t13, (e8) => {
    var A6;
    return (A6 = e8.buttonElement) == null ? void 0 : A6.id;
  }), Ee3 = (0, import_react106.useMemo)(() => ({ open: p12 === E12.Open }), [p12]), ve3 = _(n17 ? R6() : {}, { id: u24, ref: se2, "aria-activedescendant": S3(t13, t13.selectors.activeDescendantId), "aria-multiselectable": a27.mode === L7.Multi ? true : void 0, "aria-labelledby": j10, "aria-orientation": a27.orientation, onKeyDown: h11, role: "listbox", tabIndex: p12 === E12.Open ? 0 : void 0, style: { ...b11.style, ...o22, "--button-width": d3(S10, true).width }, ...R3(I8) }), he3 = L(), De4 = (0, import_react106.useMemo)(() => a27.mode === L7.Multi ? a27 : { ...a27, isSelected: v6 }, [a27, v6]);
  return import_react106.default.createElement(ne, { enabled: l16 ? g8.static || y11 : false, ownerDocument: C13 }, import_react106.default.createElement(ie2.Provider, { value: De4 }, he3({ ourProps: ve3, theirProps: b11, slot: Ee3, defaultTag: St, features: Rt, visible: P7, name: "Listbox.Options" })));
}
var _t = "div";
function Ft(g8, D8) {
  let O8 = (0, import_react51.useId)(), { id: u24 = `headlessui-listbox-option-${O8}`, disabled: i18 = false, value: l16, ...F12 } = g8, s17 = (0, import_react106.useContext)(ge4) === true, b11 = Z3("Listbox.Option"), n17 = p9("Listbox.Option"), c18 = S3(n17, (r20) => n17.selectors.isActive(r20, u24)), m11 = b11.isSelected(l16), a27 = (0, import_react106.useRef)(null), t13 = s13(a27), p12 = s3({ disabled: i18, value: l16, domRef: a27, get textValue() {
    return t13();
  } }), S10 = y(D8, a27, (r20) => {
    r20 ? b11.listRef.current.set(u24, r20) : b11.listRef.current.delete(u24);
  }), E16 = S3(n17, (r20) => n17.selectors.shouldScrollIntoView(r20, u24));
  n(() => {
    if (E16)
      return o3().requestAnimationFrame(() => {
        var r20, P7;
        (P7 = (r20 = a27.current) == null ? void 0 : r20.scrollIntoView) == null || P7.call(r20, { block: "nearest" });
      });
  }, [E16, a27]), n(() => {
    if (!s17)
      return n17.actions.registerOption(u24, p12), () => n17.actions.unregisterOption(u24);
  }, [p12, u24, s17]);
  let N2 = o5((r20) => {
    var P7;
    if (i18)
      return r20.preventDefault();
    n17.actions.onChange(l16), b11.mode === L7.Single && ((0, import_react_dom9.flushSync)(() => n17.actions.closeListbox()), (P7 = n17.state.buttonElement) == null || P7.focus({ preventScroll: true }));
  }), C13 = o5(() => {
    if (i18)
      return n17.actions.goToOption({ focus: c9.Nothing });
    n17.actions.goToOption({ focus: c9.Specific, id: u24 });
  }), f24 = u14(), L9 = o5((r20) => {
    f24.update(r20), !i18 && (c18 || n17.actions.goToOption({ focus: c9.Specific, id: u24 }, F9.Pointer));
  }), y11 = o5((r20) => {
    f24.wasMoved(r20) && (i18 || c18 || n17.actions.goToOption({ focus: c9.Specific, id: u24 }, F9.Pointer));
  }), I8 = o5((r20) => {
    f24.wasMoved(r20) && (i18 || c18 && n17.actions.goToOption({ focus: c9.Nothing }));
  }), U6 = (0, import_react106.useMemo)(() => ({ active: c18, focus: c18, selected: m11, disabled: i18, selectedOption: m11 && s17 }), [c18, m11, i18, s17]), M9 = s17 ? {} : { id: u24, ref: S10, role: "option", tabIndex: i18 === true ? void 0 : -1, "aria-disabled": i18 === true ? true : void 0, "aria-selected": m11, disabled: void 0, onClick: N2, onFocus: C13, onPointerEnter: L9, onMouseEnter: L9, onPointerMove: y11, onMouseMove: y11, onPointerLeave: I8, onMouseLeave: I8 }, H13 = L();
  return !m11 && s17 ? null : H13({ ourProps: M9, theirProps: F12, slot: U6, defaultTag: _t, name: "Listbox.Option" });
}
var Ct = import_react106.Fragment;
function Mt(g8, D8) {
  let { options: O8, placeholder: u24, ...i18 } = g8, F12 = { ref: y(D8) }, s17 = Z3("ListboxSelectedOption"), b11 = (0, import_react106.useMemo)(() => ({}), []), n17 = s17.value === void 0 || s17.value === null || s17.mode === L7.Multi && Array.isArray(s17.value) && s17.value.length === 0, c18 = L();
  return import_react106.default.createElement(ge4.Provider, { value: true }, c18({ ourProps: F12, theirProps: { ...i18, children: import_react106.default.createElement(import_react106.default.Fragment, null, u24 && n17 ? u24 : O8) }, slot: b11, defaultTag: Ct, name: "ListboxSelectedOption" }));
}
var wt2 = K(vt2);
var Bt = K(Dt);
var It = V;
...
var Nt = K(Ft);
var Ut = K(Mt);
var Io2 = Object.assign(wt2, { Button: Bt, Label: It, Options: kt, Option: Nt, SelectedOption: Ut });
...
var D7 = { [1](e8) {
  ...
  var l16, o22, d14, a27, I8;
  if (e8.menuState === 1)
    return e8;
  let t13 = { ...e8, searchQuery: "", activationTrigger: (l16 = i18.trigger) != null ? l16 : 1, __demoMode: false };
  if (i18.focus === c9.Nothing)
    return { ...t13, activeItemIndex: null };
  if (i18.focus === c9.Specific)
    return { ...t13, activeItemIndex: e8.items.findIndex((r20) => r20.id === i18.id) };
  if (i18.focus === c9.Previous) {
    let r20 = e8.activeItemIndex;
    if (r20 !== null) {
      let p12 = e8.items[r20].dataRef.current.domRef, m11 = f16(i18, { resolveItems: () => e8.items, resolveActiveIndex: () => e8.activeItemIndex, resolveId: (u24) => u24.id, resolveDisabled: (u24) => u24.dataRef.current.disabled });
      if (m11 !== null) {
        let u24 = e8.items[m11].dataRef.current.domRef;
        if (((o22 = p12.current) == null ? void 0 : o22.previousElementSibling) === u24.current || ((d14 = u24.current) == null ? void 0 : d14.previousElementSibling) === null)
          return { ...t13, activeItemIndex: m11 };
      }
    }
    ...
    if (r20 !== null) {
      ...
      if (m11 !== null) {
        let u24 = e8.items[m11].dataRef.current.domRef;
        if (((a27 = p12.current) == null ? void 0 : a27.nextElementSibling) === u24.current || ((I8 = u24.current) == null ? void 0 : I8.nextElementSibling) === null)
          return { ...t13, activeItemIndex: m11 };
      }
    }
  }
  ...
  }), d14 = o22 ? e8.items.indexOf(o22) : -1;
  ...
  for (let [l16, o22] of t13.entries())
    if (s17.has(o22.id) && (n17.push(l16), s17.delete(o22.id), s17.size === 0))
      break;
  if (n17.length > 0) {
    t13 = t13.slice();
    for (let l16 of n17.reverse())
      t13.splice(l16, 1);
  }
...
function tt(c18, E16) {
  let p12 = (0, import_react51.useId)(), { __demoMode: a27 = false, ...s17 } = c18, l16 = s14({ id: p12, __demoMode: a27 }), [n17, g8, y11] = S3(l16, (T15) => [T15.menuState, T15.itemsElement, T15.buttonElement]), I8 = y(E16), o22 = x3.get(null), h11 = S3(o22, (0, import_react108.useCallback)((T15) => o22.selectors.isTop(T15, p12), [o22, p12]));
  k4(h11, [y11, g8], (T15, u24) => {
    var f24;
    l16.send({ type: F10.CloseMenu }), A2(u24, h5.Loose) || (T15.preventDefault(), (f24 = l16.state.buttonElement) == null || f24.focus());
  });
  let _10 = o5(() => {
    l16.send({ type: F10.CloseMenu });
  }), M9 = (0, import_react108.useMemo)(() => ({ open: n17 === E13.Open, close: _10 }), [n17, _10]), i18 = { ref: I8 }, b11 = L();
  return import_react108.default.createElement(Ae, null, import_react108.default.createElement(a24.Provider, { value: l16 }, import_react108.default.createElement(c8, { value: u(n17, { [E13.Open]: i11.Open, [E13.Closed]: i11.Closed }) }, b11({ ourProps: i18, theirProps: s17, slot: M9, defaultTag: et, name: "Menu" }))));
}
var ot = "button";
function nt(c18, E16) {
  let p12 = p10("Menu.Button"), a27 = (0, import_react51.useId)(), { id: s17 = `headlessui-menu-button-${a27}`, disabled: l16 = false, autoFocus: n17 = false, ...g8 } = c18, y11 = (0, import_react108.useRef)(null), I8 = be(), o22 = y(E16, y11, Fe2(), o5((e8) => p12.send({ type: F10.SetButtonElement, element: e8 }))), h11 = o5((e8) => {
    switch (e8.key) {
      case o10.Space:
      case o10.Enter:
      case o10.ArrowDown:
        e8.preventDefault(), e8.stopPropagation(), p12.send({ type: F10.OpenMenu, focus: { focus: c9.First } });
        break;
      case o10.ArrowUp:
        e8.preventDefault(), e8.stopPropagation(), p12.send({ type: F10.OpenMenu, focus: { focus: c9.Last } });
        break;
    }
  }), _10 = o5((e8) => {
    switch (e8.key) {
  ...
  }), [M9, i18, b11] = S3(p12, (e8) => [e8.menuState, e8.buttonElement, e8.itemsElement]), T15 = M9 === E13.Open;
  R2(T15, { trigger: i18, action: (0, import_react108.useCallback)((e8) => {
    if (i18 != null && i18.contains(e8.target))
      return L4.Ignore;
    let R6 = e8.target.closest('[role="menuitem"]:not([data-disabled])');
    return n4(R6) ? L4.Select(R6) : b11 != null && b11.contains(e8.target) ? L4.Ignore : L4.Close;
  }, [i18, b11]), close: (0, import_react108.useCallback)(() => p12.send({ type: F10.CloseMenu }), []), select: (0, import_react108.useCallback)((e8) => e8.click(), []) });
  let u24 = o5((e8) => {
    var R6;
    if (e8.button === 0) {
      if (s5(e8.currentTarget))
        return e8.preventDefault();
      l16 || (M9 === E13.Open ? ((0, import_react_dom10.flushSync)(() => p12.send({ type: F10.CloseMenu })), (R6 = y11.current) == null || R6.focus({ preventScroll: true })) : (e8.preventDefault(), p12.send({ type: F10.OpenMenu, focus: { focus: c9.Nothing }, trigger: O7.Pointer })));
    }
  }), { isFocusVisible: f24, focusProps: v6 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: n17 }), { isHovered: S10, hoverProps: O8 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: l16 }), { pressed: F12, pressProps: U6 } = w({ disabled: l16 }), H13 = (0, import_react108.useMemo)(() => ({ open: M9 === E13.Open, active: F12 || M9 === E13.Open, disabled: l16, hover: S10, focus: f24, autofocus: n17 }), [M9, S10, f24, F12, l16, n17]), G6 = _(I8(), { ref: o22, id: s17, type: e5(c18, y11.current), "aria-haspopup": "menu", "aria-controls": b11 == null ? void 0 : b11.id, "aria-expanded": M9 === E13.Open, disabled: l16 || void 0, autoFocus: n17, onKeyDown: h11, onKeyUp: _10, onPointerDown: u24 }, v6, O8, U6);
  return L()({ ourProps: G6, theirProps: g8, slot: H13, defaultTag: ot, name: "Menu.Button" });
}
var rt = "div";
var at = O.RenderStrategy | O.Static;
function st(c18, E16) {
  let p12 = (0, import_react51.useId)(), { id: a27 = `headlessui-menu-items-${p12}`, anchor: s17, portal: l16 = false, modal: n17 = true, transition: g8 = false, ...y11 } = c18, I8 = ye(s17), o22 = p10("Menu.Items"), [h11, _10] = Re(I8), M9 = Te(), [i18, b11] = (0, import_react108.useState)(null), T15 = y(E16, I8 ? h11 : null, o5((t13) => o22.send({ type: F10.SetItemsElement, element: t13 })), b11), [u24, f24] = S3(o22, (t13) => [t13.menuState, t13.buttonElement]), v6 = n11(f24), S10 = n11(i18);
  I8 && (l16 = true);
  let O8 = u16(), [F12, U6] = x4(g8, i18, O8 !== null ? (O8 & i11.Open) === i11.Open : u24 === E13.Open);
  p5(F12, f24, () => {
    o22.send({ type: F10.CloseMenu });
  });
  let H13 = S3(o22, (t13) => t13.__demoMode), G6 = H13 ? false : n17 && u24 === E13.Open;
  f13(G6, S10);
  let w13 = H13 ? false : n17 && u24 === E13.Open;
  y5(w13, { allowed: (0, import_react108.useCallback)(() => [f24, i18], [f24, i18]) });
  let e8 = u24 !== E13.Open, le2 = s12(e8, f24) ? false : F12;
  (0, import_react108.useEffect)(() => {
    let t13 = i18;
    t13 && u24 === E13.Open && t13 !== (S10 == null ? void 0 : S10.activeElement) && t13.focus({ preventScroll: true });
  }, [u24, i18, S10]), F3(u24 === E13.Open, { container: i18, accept(t13) {
  ...
  let z5 = p(), pe4 = o5((t13) => {
    var N2, Y3, Z5;
    switch (z5.dispose(), t13.key) {
      case o10.Space:
        if (o22.state.searchQuery !== "")
          return t13.preventDefault(), t13.stopPropagation(), o22.send({ type: F10.Search, value: t13.key });
      case o10.Enter:
        if (t13.preventDefault(), t13.stopPropagation(), o22.state.activeItemIndex !== null) {
          let { dataRef: ce3 } = o22.state.items[o22.state.activeItemIndex];
          (Y3 = (N2 = ce3.current) == null ? void 0 : N2.domRef.current) == null || Y3.click();
        }
        o22.send({ type: F10.CloseMenu }), V2(o22.state.buttonElement);
        break;
      case o10.ArrowDown:
        return t13.preventDefault(), t13.stopPropagation(), o22.send({ type: F10.GoToItem, focus: c9.Next });
      case o10.ArrowUp:
        return t13.preventDefault(), t13.stopPropagation(), o22.send({ type: F10.GoToItem, focus: c9.Previous });
      case o10.Home:
      case o10.PageUp:
        return t13.preventDefault(), t13.stopPropagation(), o22.send({ type: F10.GoToItem, focus: c9.First });
      case o10.End:
      case o10.PageDown:
        return t13.preventDefault(), t13.stopPropagation(), o22.send({ type: F10.GoToItem, focus: c9.Last });
      case o10.Escape:
        t13.preventDefault(), t13.stopPropagation(), (0, import_react_dom10.flushSync)(() => o22.send({ type: F10.CloseMenu })), (Z5 = o22.state.buttonElement) == null || Z5.focus({ preventScroll: true });
        break;
      case o10.Tab:
        t13.preventDefault(), t13.stopPropagation(), (0, import_react_dom10.flushSync)(() => o22.send({ type: F10.CloseMenu })), j5(o22.state.buttonElement, t13.shiftKey ? T5.Previous : T5.Next);
        break;
      default:
        t13.key.length === 1 && (o22.send({ type: F10.Search, value: t13.key }), z5.setTimeout(() => o22.send({ type: F10.ClearSearch }), 350));
        break;
    }
  }), ie4 = o5((t13) => {
    switch (t13.key) {
  ...
  }), ue5 = (0, import_react108.useMemo)(() => ({ open: u24 === E13.Open }), [u24]), de6 = _(I8 ? M9() : {}, { "aria-activedescendant": S3(o22, o22.selectors.activeDescendantId), "aria-labelledby": S3(o22, (t13) => {
    var N2;
    return (N2 = t13.buttonElement) == null ? void 0 : N2.id;
  }), id: a27, onKeyDown: pe4, onKeyUp: ie4, role: "menu", tabIndex: u24 === E13.Open ? 0 : void 0, ref: T15, style: { ...y11.style, ..._10, "--button-width": d3(f24, true).width }, ...R3(U6) }), me5 = L();
  return import_react108.default.createElement(ne, { enabled: l16 ? c18.static || F12 : false, ownerDocument: v6 }, me5({ ourProps: de6, theirProps: y11, slot: ue5, defaultTag: rt, features: at, visible: le2, name: "Menu.Items" }));
}
var lt = import_react108.Fragment;
function pt(c18, E16) {
  let p12 = (0, import_react51.useId)(), { id: a27 = `headlessui-menu-item-${p12}`, disabled: s17 = false, ...l16 } = c18, n17 = p10("Menu.Item"), g8 = S3(n17, (e8) => n17.selectors.isActive(e8, a27)), y11 = (0, import_react108.useRef)(null), I8 = y(E16, y11), o22 = S3(n17, (e8) => n17.selectors.shouldScrollIntoView(e8, a27));
  n(() => {
    if (o22)
      return o3().requestAnimationFrame(() => {
        var e8, R6;
        (R6 = (e8 = y11.current) == null ? void 0 : e8.scrollIntoView) == null || R6.call(e8, { block: "nearest" });
      });
  }, [o22, y11]);
  ...
  let M9 = o5(() => {
    ...
    if (s17)
      return n17.send({ type: F10.GoToItem, focus: c9.Nothing });
    n17.send({ type: F10.GoToItem, focus: c9.Specific, id: a27 });
  }), T15 = u14(), u24 = o5((e8) => {
    T15.update(e8), !s17 && (g8 || n17.send({ type: F10.GoToItem, focus: c9.Specific, id: a27, trigger: O7.Pointer }));
  }), f24 = o5((e8) => {
    T15.wasMoved(e8) && (s17 || g8 || n17.send({ type: F10.GoToItem, focus: c9.Specific, id: a27, trigger: O7.Pointer }));
  }), v6 = o5((e8) => {
    T15.wasMoved(e8) && (s17 || g8 && n17.send({ type: F10.GoToItem, focus: c9.Nothing }));
  }), [S10, O8] = Q(), [F12, U6] = w3(), H13 = (0, import_react108.useMemo)(() => ({ active: g8, focus: g8, disabled: s17, close: M9 }), [g8, s17, M9]), G6 = { id: a27, ref: I8, role: "menuitem", tabIndex: s17 === true ? void 0 : -1, "aria-disabled": s17 === true ? true : void 0, "aria-labelledby": S10, "aria-describedby": F12, disabled: void 0, onClick: i18, onFocus: b11, onPointerEnter: u24, onMouseEnter: u24, onPointerMove: f24, onMouseMove: f24, onPointerLeave: v6, onMouseLeave: v6 }, w13 = L();
  return import_react108.default.createElement(O8, null, import_react108.default.createElement(U6, null, w13({ ourProps: G6, theirProps: l16, slot: H13, defaultTag: lt, name: "Menu.Item" })));
}
var it = "div";
function ut(c18, E16) {
  let [p12, a27] = Q(), s17 = c18, l16 = { ref: E16, "aria-labelledby": p12, role: "group" }, n17 = L();
...
function mt(c18, E16) {
  ...
  let n17 = { id: a27, ref: E16, role: "presentation", ...l16.props };
  return L()({ ourProps: n17, theirProps: s17, slot: {}, defaultTag: dt, name: "Menu.Heading" });
}
var ct = "div";
function Tt(c18, E16) {
  let p12 = c18, a27 = { ref: E16, role: "separator" };
...
var Mt2 = K(mt);
var bt2 = K(Tt);
var lo = Object.assign(ft, { Button: yt, Items: Pt, Item: Et2, Section: gt, Heading: Mt2, Separator: bt2 });
...
var i15 = class _i extends E5 {
  constructor(e8) {
    ...
    p11(this, "selectors", { isPortalled: (e9) => {
      if (!e9.button || !e9.panel)
        return false;
      for (let r20 of document.querySelectorAll("body > *"))
        if (Number(r20 == null ? void 0 : r20.contains(e9.button)) ^ Number(r20 == null ? void 0 : r20.contains(e9.panel)))
          return true;
      let o22 = b3(), u24 = o22.indexOf(e9.button), a27 = (u24 + o22.length - 1) % o22.length, l16 = (u24 + 1) % o22.length, d14 = o22[a27], c18 = o22[l16];
...
function f22({ id: r20, __demoMode: o22 = false }) {
  let e8 = (0, import_react109.useMemo)(() => i15.new({ id: r20, __demoMode: o22 }), []);
  return c10(() => e8.dispose()), e8;
}

// node_modules/@headlessui/react/dist/components/popover/popover.js
var ge5 = (0, import_react110.createContext)(null);
ge5.displayName = "PopoverGroupContext";
function Ge2() {
  return (0, import_react110.useContext)(ge5);
}
...
function dt2(b11, M9) {
  var k8;
  let F12 = (0, import_react51.useId)(), { __demoMode: B4 = false, ...d14 } = b11, r20 = f22({ id: F12, __demoMode: B4 }), g8 = (0, import_react110.useRef)(null), t13 = y(M9, T2((n17) => {
    g8.current = n17;
  })), [_10, f24, o22, O8, E16] = S3(r20, (0, import_react110.useCallback)((n17) => [n17.popoverState, n17.button, n17.panel, n17.buttonId, n17.panelId], [])), P7 = n11((k8 = g8.current) != null ? k8 : f24), A6 = s3(O8), a27 = s3(E16), i18 = (0, import_react110.useMemo)(() => ({ buttonId: A6, panelId: a27, close: r20.actions.close }), [A6, a27, r20]), u24 = Ge2(), l16 = u24 == null ? void 0 : u24.registerPopover, v6 = o5(() => {
    var n17;
    return (n17 = u24 == null ? void 0 : u24.isFocusWithinPopoverGroup()) != null ? n17 : (P7 == null ? void 0 : P7.activeElement) && ((f24 == null ? void 0 : f24.contains(P7.activeElement)) || (o22 == null ? void 0 : o22.contains(P7.activeElement)));
  });
  (0, import_react110.useEffect)(() => l16 == null ? void 0 : l16(i18), [l16, i18]);
  let [m11, j10] = oe(), $7 = y8(f24), J7 = H8({ mainTreeNode: $7, portals: m11, defaultContainers: [{ get current() {
    return r20.state.button;
  } }, { get current() {
    return r20.state.panel;
  } }] });
  E7(P7 == null ? void 0 : P7.defaultView, "focus", (n17) => {
    var D8, z5, G6, U6, L9, N2;
    n17.target !== window && i4(n17.target) && r20.state.popoverState === I7.Open && (v6() || r20.state.button && r20.state.panel && (J7.contains(n17.target) || (z5 = (D8 = r20.state.beforePanelSentinel.current) == null ? void 0 : D8.contains) != null && z5.call(D8, n17.target) || (U6 = (G6 = r20.state.afterPanelSentinel.current) == null ? void 0 : G6.contains) != null && U6.call(G6, n17.target) || (N2 = (L9 = r20.state.afterButtonSentinel.current) == null ? void 0 : L9.contains) != null && N2.call(L9, n17.target) || r20.actions.close()));
  }, true);
  let x13 = _10 === I7.Open;
  k4(x13, J7.resolveContainers, (n17, D8) => {
  ...
  return import_react110.default.createElement(P6, { node: $7 }, import_react110.default.createElement(Ae, null, import_react110.default.createElement(fe5.Provider, { value: null }, import_react110.default.createElement(a25.Provider, { value: r20 }, import_react110.default.createElement(C5, { value: r20.actions.refocusableClose }, import_react110.default.createElement(c8, { value: te4 }, import_react110.default.createElement(j10, null, C13({ ourProps: q5, theirProps: d14, slot: X4, defaultTag: ct2, name: "Popover" }))))))));
}
var ft2 = "button";
function Pt2(b11, M9) {
  let F12 = (0, import_react51.useId)(), { id: B4 = `headlessui-popover-button-${F12}`, disabled: d14 = false, autoFocus: r20 = false, ...g8 } = b11, t13 = u23("Popover.Button"), [_10, f24, o22, O8, E16, P7, A6] = S3(t13, (0, import_react110.useCallback)((e8) => [e8.popoverState, t13.selectors.isPortalled(e8), e8.button, e8.buttonId, e8.panel, e8.panelId, e8.afterButtonSentinel], [])), a27 = (0, import_react110.useRef)(null), i18 = `headlessui-focus-sentinel-${(0, import_react51.useId)()}`, u24 = Ge2(), l16 = u24 == null ? void 0 : u24.closeOthers, m11 = ut2() !== null;
  (0, import_react110.useEffect)(() => {
    if (!m11)
      return t13.actions.setButtonId(B4), () => t13.actions.setButtonId(null);
  }, [m11, B4, t13]);
  let [j10] = (0, import_react110.useState)(() => Symbol()), $7 = y(a27, M9, Fe2(), o5((e8) => {
    if (!m11) {
      if (e8)
        t13.state.buttons.current.push(j10);
      else {
        let p12 = t13.state.buttons.current.indexOf(j10);
  ...
  })), J7 = y(a27, M9), x13 = n11(a27), X4 = o5((e8) => {
    var p12, h11, S10;
    if (m11) {
      if (t13.state.popoverState === I7.Closed)
        return;
      switch (e8.key) {
        case o10.Space:
        case o10.Enter:
      ...
      switch (e8.key) {
        ...
        case o10.Enter:
          ...
          break;
        case o10.Escape:
          if (t13.state.popoverState !== I7.Open)
            return l16 == null ? void 0 : l16(t13.state.buttonId);
          if (!a27.current || x13 != null && x13.activeElement && !a27.current.contains(x13.activeElement))
            return;
    ...
    var p12, h11;
    s5(e8.currentTarget) || d14 || (m11 ? (t13.actions.close(), (p12 = t13.state.button) == null || p12.focus()) : (e8.preventDefault(), e8.stopPropagation(), t13.state.popoverState === I7.Closed ? (l16 == null || l16(t13.state.buttonId), t13.actions.open()) : t13.actions.close(), (h11 = t13.state.button) == null || h11.focus()));
  }), C13 = o5((e8) => {
    e8.preventDefault(), e8.stopPropagation();
  }), { isFocusVisible: k8, focusProps: n17 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: r20 }), { isHovered: D8, hoverProps: z5 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: d14 }), { pressed: G6, pressProps: U6 } = w({ disabled: d14 }), L9 = _10 === I7.Open, N2 = (0, import_react110.useMemo)(() => ({ open: L9, active: G6 || L9, disabled: d14, hover: D8, focus: k8, autofocus: r20 }), [L9, D8, k8, G6, d14, r20]), ae4 = e5(b11, o22), Pe3 = m11 ? _({ ref: J7, type: ae4, onKeyDown: X4, onClick: q5, disabled: d14 || void 0, autoFocus: r20 }, n17, z5, U6) : _({ ref: $7, id: O8, type: ae4, "aria-expanded": _10 === I7.Open, "aria-controls": E16 ? P7 : void 0, disabled: d14 || void 0, autoFocus: r20, onKeyDown: X4, onKeyUp: te4, onClick: q5, onMouseDown: C13 }, n17, z5, U6), se2 = u20(), s17 = o5(() => {
    if (!n4(t13.state.panel))
      return;
  ...
  return import_react110.default.createElement(import_react110.default.Fragment, null, R6({ ourProps: Pe3, theirProps: g8, slot: N2, defaultTag: ft2, name: "Popover.Button" }), L9 && !m11 && f24 && import_react110.default.createElement(f4, { id: i18, ref: A6, features: s4.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: s17 }));
}
var vt3 = "div";
var mt2 = O.RenderStrategy | O.Static;
function ke(b11, M9) {
  let F12 = (0, import_react51.useId)(), { id: B4 = `headlessui-popover-backdrop-${F12}`, transition: d14 = false, ...r20 } = b11, g8 = u23("Popover.Backdrop"), t13 = S3(g8, (0, import_react110.useCallback)((l16) => l16.popoverState, [])), [_10, f24] = (0, import_react110.useState)(null), o22 = y(M9, f24), O8 = u16(), [E16, P7] = x4(d14, _10, O8 !== null ? (O8 & i11.Open) === i11.Open : t13 === I7.Open), A6 = o5((l16) => {
    if (s5(l16.currentTarget))
  ...
  return L()({ ourProps: i18, theirProps: r20, slot: a27, defaultTag: vt3, features: mt2, visible: E16, name: "Popover.Backdrop" });
}
var Tt2 = "div";
var Et3 = O.RenderStrategy | O.Static;
function bt3(b11, M9) {
  let F12 = (0, import_react51.useId)(), { id: B4 = `headlessui-popover-panel-${F12}`, focus: d14 = false, anchor: r20, portal: g8 = false, modal: t13 = false, transition: _10 = false, ...f24 } = b11, o22 = u23("Popover.Panel"), O8 = S3(o22, o22.selectors.isPortalled), [E16, P7, A6, a27, i18] = S3(o22, (0, import_react110.useCallback)((s17) => [s17.popoverState, s17.button, s17.__demoMode, s17.beforePanelSentinel, s17.afterPanelSentinel], [])), u24 = `headlessui-focus-sentinel-before-${F12}`, l16 = `headlessui-focus-sentinel-after-${F12}`, v6 = (0, import_react110.useRef)(null), m11 = ye(r20), [j10, $7] = Re(m11), J7 = Te();
  m11 && (g8 = true);
  let [x13, X4] = (0, import_react110.useState)(null), te4 = y(v6, M9, m11 ? j10 : null, o22.actions.setPanel, X4), q5 = n11(P7), C13 = n11(v6);
  n(() => (o22.actions.setPanelId(B4), () => o22.actions.setPanelId(null)), [B4, o22]);
  let k8 = u16(), [n17, D8] = x4(_10, x13, k8 !== null ? (k8 & i11.Open) === i11.Open : E16 === I7.Open);
  p5(n17, P7, o22.actions.close), f13(A6 ? false : t13 && n17, C13);
  let G6 = o5((s17) => {
    var R6;
    switch (s17.key) {
      case o10.Escape:
        if (o22.state.popoverState !== I7.Open || !v6.current || C13 != null && C13.activeElement && !v6.current.contains(C13.activeElement))
          return;
  ...
  (0, import_react110.useEffect)(() => {
    var s17;
    b11.static || E16 === I7.Closed && ((s17 = b11.unmount) == null || s17) && o22.actions.setPanel(null);
  }, [E16, b11.unmount, b11.static, o22]), (0, import_react110.useEffect)(() => {
    if (A6 || !d14 || E16 !== I7.Open || !v6.current)
      return;
    let s17 = C13 == null ? void 0 : C13.activeElement;
    v6.current.contains(s17) || g2(v6.current, T5.First);
  }, [A6, d14, v6.current, E16]);
  let U6 = (0, import_react110.useMemo)(() => ({ open: E16 === I7.Open, close: o22.actions.refocusableClose }), [E16, o22]), L9 = _(m11 ? J7() : {}, { ref: te4, id: B4, onKeyDown: G6, onBlur: d14 && E16 === I7.Open ? (s17) => {
    var e8, p12, h11, S10, w13;
    let R6 = s17.relatedTarget;
    R6 && v6.current && ((e8 = v6.current) != null && e8.contains(R6) || (o22.actions.close(), ((h11 = (p12 = a27.current) == null ? void 0 : p12.contains) != null && h11.call(p12, R6) || (w13 = (S10 = i18.current) == null ? void 0 : S10.contains) != null && w13.call(S10, R6)) && R6.focus({ preventScroll: true })));
  } : void 0, tabIndex: -1, style: { ...f24.style, ...$7, "--button-width": d3(P7, true).width }, ...R3(D8) }), N2 = u20(), ae4 = o5(() => {
    let s17 = v6.current;
    if (!s17)
      return;
    function R6() {
      u(N2.current, { [a20.Forwards]: () => {
        var p12;
        g2(s17, T5.First) === y6.Error && ((p12 = o22.state.afterPanelSentinel.current) == null || p12.focus());
      }, [a20.Backwards]: () => {
        var e8;
    ...
    function R6() {
      u(N2.current, { [a20.Forwards]: () => {
        if (!o22.state.button)
          return;
        let e8 = b3(), p12 = e8.indexOf(o22.state.button), h11 = e8.slice(0, p12 + 1), w13 = [...e8.slice(p12 + 1), ...h11];
        for (let ve3 of w13.slice())
          if (ve3.dataset.headlessuiFocusGuard === "true" || x13 != null && x13.contains(ve3)) {
            let Re5 = w13.indexOf(ve3);
            Re5 !== -1 && w13.splice(Re5, 1);
          }
        g2(w13, T5.First, { sorted: false });
      }, [a20.Backwards]: () => {
        var p12;
        g2(s17, T5.Previous) === y6.Error && ((p12 = o22.state.button) == null || p12.focus());
      } });
    }
    R6();
  }), se2 = L();
  return import_react110.default.createElement(s9, null, import_react110.default.createElement(fe5.Provider, { value: B4 }, import_react110.default.createElement(C5, { value: o22.actions.refocusableClose }, import_react110.default.createElement(ne, { enabled: g8 ? b11.static || n17 : false, ownerDocument: q5 }, n17 && O8 && import_react110.default.createElement(f4, { id: u24, ref: a27, features: s4.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: ae4 }), se2({ ourProps: L9, theirProps: f24, slot: U6, defaultTag: Tt2, features: Et3, visible: n17, name: "Popover.Panel" }), n17 && O8 && import_react110.default.createElement(f4, { id: l16, ref: i18, features: s4.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: Pe3 })))));
}
var yt2 = "div";
function gt2(b11, M9) {
  let F12 = (0, import_react110.useRef)(null), B4 = y(F12, M9), [d14, r20] = (0, import_react110.useState)([]), g8 = o5((a27) => {
    r20((i18) => {
    ...
    return (u24 = F12.current) != null && u24.contains(i18) ? true : d14.some((l16) => {
      var v6, m11;
      return ((v6 = a27.getElementById(l16.buttonId.current)) == null ? void 0 : v6.contains(i18)) || ((m11 = a27.getElementById(l16.panelId.current)) == null ? void 0 : m11.contains(i18));
    });
  }), f24 = o5((a27) => {
    for (let i18 of d14)
      i18.buttonId.current !== a27 && i18.close();
  }), o22 = (0, import_react110.useMemo)(() => ({ registerPopover: t13, unregisterPopover: g8, isFocusWithinPopoverGroup: _10, closeOthers: f24 }), [t13, g8, _10, f24]), O8 = (0, import_react110.useMemo)(() => ({}), []), E16 = b11, P7 = { ref: B4 }, A6 = L();
  return import_react110.default.createElement(P6, null, import_react110.default.createElement(ge5.Provider, { value: o22 }, A6({ ourProps: P7, theirProps: E16, slot: O8, defaultTag: yt2, name: "Popover.Group" })));
}
var Rt2 = K(dt2);
var Ft2 = K(Pt2);
var Bt2 = K(ke);
...
var Fe5 = { [0](o22, t13) {
  ...
  let e8 = o22.options.slice(), i18 = o22.options.findIndex((v6) => v6.id === t13.id);
  return i18 === -1 ? o22 : (e8.splice(i18, 1), { ...o22, options: e8 });
} };
var J5 = (0, import_react111.createContext)(null);
J5.displayName = "RadioGroupDataContext";
function X3(o22) {
  let t13 = (0, import_react111.useContext)(J5);
  if (t13 === null) {
...
var z3 = (0, import_react111.createContext)(null);
z3.displayName = "RadioGroupActionsContext";
function q4(o22) {
  let t13 = (0, import_react111.useContext)(z3);
  if (t13 === null) {
    let e8 = new Error(`<${o22} /> is missing a parent <RadioGroup /> component.`);
...
function Se2(o22, t13) {
  let e8 = (0, import_react51.useId)(), i18 = a3(), { id: v6 = `headlessui-radiogroup-${e8}`, value: m11, form: D8, name: n17, onChange: f24, by: u24, disabled: a27 = i18 || false, defaultValue: M9, tabIndex: T15 = 0, ...S10 } = o22, R6 = u9(u24), [A6, y11] = (0, import_react111.useReducer)(Ue2, { options: [] }), p12 = A6.options, [C13, _10] = Q(), [h11, L9] = w3(), k8 = (0, import_react111.useRef)(null), c18 = y(k8, t13), b11 = l2(M9), [l16, I8] = T(m11, f24, b11), g8 = (0, import_react111.useMemo)(() => p12.find((r20) => !r20.propsRef.current.disabled), [p12]), O8 = (0, import_react111.useMemo)(() => p12.some((r20) => R6(r20.propsRef.current.value, l16)), [p12, l16]), s17 = o5((r20) => {
    var d14;
    if (a27 || R6(r20, l16))
      return false;
    let F12 = (d14 = p12.find((w13) => R6(w13.propsRef.current.value, r20))) == null ? void 0 : d14.propsRef.current;
    return F12 != null && F12.disabled ? false : (I8 == null || I8(r20), true);
  }), ue5 = o5((r20) => {
    let F12 = k8.current;
    if (!F12)
      return;
    let d14 = o2(F12), w13 = p12.filter((P7) => P7.propsRef.current.disabled === false).map((P7) => P7.element.current);
    switch (r20.key) {
      case o10.Enter:
      ...
      case o10.ArrowLeft:
      case o10.ArrowUp:
        if (r20.preventDefault(), r20.stopPropagation(), g2(w13, T5.Previous | T5.WrapAround) === y6.Success) {
          let E16 = p12.find((W2) => W2.element.current === (d14 == null ? void 0 : d14.activeElement));
          E16 && s17(E16.propsRef.current.value);
        }
        break;
      case o10.ArrowRight:
      case o10.ArrowDown:
        if (r20.preventDefault(), r20.stopPropagation(), g2(w13, T5.Next | T5.WrapAround) === y6.Success) {
          let E16 = p12.find((W2) => W2.element.current === (d14 == null ? void 0 : d14.activeElement));
          E16 && s17(E16.propsRef.current.value);
        }
        break;
      case o10.Space:
        {
          ...
          let P7 = p12.find((E16) => E16.element.current === (d14 == null ? void 0 : d14.activeElement));
          P7 && s17(P7.propsRef.current.value);
        }
        break;
    }
  }), Q5 = o5((r20) => (y11({ type: 0, ...r20 }), () => y11({ type: 1, id: r20.id }))), ce3 = (0, import_react111.useMemo)(() => ({ value: l16, firstOption: g8, containsCheckedOption: O8, disabled: a27, compare: R6, tabIndex: T15, ...A6 }), [l16, g8, O8, a27, R6, T15, A6]), fe6 = (0, import_react111.useMemo)(() => ({ registerOption: Q5, change: s17 }), [Q5, s17]), Te6 = { ref: c18, id: v6, role: "radiogroup", "aria-labelledby": C13, "aria-describedby": h11, onKeyDown: ue5 }, Re5 = (0, import_react111.useMemo)(() => ({ value: l16 }), [l16]), me5 = (0, import_react111.useCallback)(() => {
    if (b11 !== void 0)
      return s17(b11);
  }, [s17, b11]), ye4 = L();
  return import_react111.default.createElement(L9, { name: "RadioGroup.Description" }, import_react111.default.createElement(_10, { name: "RadioGroup.Label" }, import_react111.default.createElement(z3.Provider, { value: fe6 }, import_react111.default.createElement(J5.Provider, { value: ce3 }, n17 != null && import_react111.default.createElement(j2, { disabled: a27, data: { [n17]: l16 || "on" }, overrides: { type: "radio", checked: l16 != null }, form: D8, onReset: me5 }), ye4({ ourProps: Te6, theirProps: S10, slot: Re5, defaultTag: Me2, name: "RadioGroup" })))));
}
var He3 = "div";
function we2(o22, t13) {
  var g8;
  let e8 = X3("RadioGroup.Option"), i18 = q4("RadioGroup.Option"), v6 = (0, import_react51.useId)(), { id: m11 = `headlessui-radiogroup-option-${v6}`, value: D8, disabled: n17 = e8.disabled || false, autoFocus: f24 = false, ...u24 } = o22, a27 = (0, import_react111.useRef)(null), M9 = y(a27, t13), [T15, S10] = Q(), [R6, A6] = w3(), y11 = s3({ value: D8, disabled: n17 });
  n(() => i18.registerOption({ id: m11, element: a27, propsRef: y11 }), [m11, i18, a27, y11]);
  let p12 = o5((O8) => {
    var s17;
    if (s5(O8.currentTarget))
      return O8.preventDefault();
    i18.change(D8) && ((s17 = a27.current) == null || s17.focus());
  }), C13 = ((g8 = e8.firstOption) == null ? void 0 : g8.id) === m11, { isFocusVisible: _10, focusProps: h11 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: f24 }), { isHovered: L9, hoverProps: k8 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: n17 }), c18 = e8.compare(e8.value, D8), b11 = _({ ref: M9, id: m11, role: "radio", "aria-checked": c18 ? "true" : "false", "aria-labelledby": T15, "aria-describedby": R6, "aria-disabled": n17 ? true : void 0, tabIndex: (() => n17 ? -1 : c18 || !e8.containsCheckedOption && C13 ? e8.tabIndex : -1)(), onClick: n17 ? void 0 : p12, autoFocus: f24 }, h11, k8), l16 = (0, import_react111.useMemo)(() => ({ checked: c18, disabled: n17, active: _10, hover: L9, focus: _10, autofocus: f24 }), [c18, n17, L9, _10, f24]), I8 = L();
...
function We2(o22, t13) {
  var g8;
  let e8 = X3("Radio"), i18 = q4("Radio"), v6 = (0, import_react51.useId)(), m11 = u4(), D8 = a3(), { id: n17 = m11 || `headlessui-radio-${v6}`, value: f24, disabled: u24 = e8.disabled || D8 || false, autoFocus: a27 = false, ...M9 } = o22, T15 = (0, import_react111.useRef)(null), S10 = y(T15, t13), R6 = N(), A6 = U2(), y11 = s3({ value: f24, disabled: u24 });
  ...
  }), { isFocusVisible: C13, focusProps: _10 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: a27 }), { isHovered: h11, hoverProps: L9 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: u24 }), k8 = ((g8 = e8.firstOption) == null ? void 0 : g8.id) === n17, c18 = e8.compare(e8.value, f24), b11 = _({ ref: S10, id: n17, role: "radio", "aria-checked": c18 ? "true" : "false", "aria-labelledby": R6, "aria-describedby": A6, "aria-disabled": u24 ? true : void 0, tabIndex: (() => u24 ? -1 : c18 || !e8.containsCheckedOption && k8 ? e8.tabIndex : -1)(), autoFocus: a27, onClick: u24 ? void 0 : p12 }, _10, L9), l16 = (0, import_react111.useMemo)(() => ({ checked: c18, disabled: u24, hover: h11, focus: C13, autofocus: a27 }), [c18, u24, h11, C13, a27]);
...
var H11 = "select";
function B3(a27, i18) {
  let p12 = (0, import_react51.useId)(), d14 = u4(), n17 = a3(), { id: c18 = d14 || `headlessui-select-${p12}`, disabled: e8 = n17 || false, invalid: t13 = false, autoFocus: o22 = false, ...f24 } = a27, m11 = N(), u24 = U2(), { isFocusVisible: r20, focusProps: T15 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: o22 }), { isHovered: l16, hoverProps: b11 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e8 }), { pressed: s17, pressProps: y11 } = w({ disabled: e8 }), P7 = _({ ref: i18, id: c18, "aria-labelledby": m11, "aria-describedby": u24, "aria-invalid": t13 ? "true" : void 0, disabled: e8 || void 0, autoFocus: o22 }, T15, b11, y11), S10 = (0, import_react112.useMemo)(() => ({ disabled: e8, invalid: t13, hover: l16, focus: r20, active: s17, autofocus: o22 }), [e8, t13, l16, r20, s17, o22]);
  return L()({ ourProps: P7, theirProps: f24, slot: S10, defaultTag: H11, name: "Select" });
}
var j9 = K(B3);

// node_modules/@headlessui/react/dist/components/switch/switch.js
var import_react113 = __toESM(require_react(), 1);
var E14 = (0, import_react113.createContext)(null);
E14.displayName = "GroupContext";
var ge7 = import_react113.Fragment;
function ve(n17) {
  var u24;
  let [o22, s17] = (0, import_react113.useState)(null), [h11, b11] = Q(), [T15, t13] = w3(), p12 = (0, import_react113.useMemo)(() => ({ switch: o22, setSwitch: s17 }), [o22, s17]), y11 = {}, S10 = n17, c18 = L();
  return import_react113.default.createElement(t13, { name: "Switch.Description", value: T15 }, import_react113.default.createElement(b11, { name: "Switch.Label", value: h11, props: { htmlFor: (u24 = p12.switch) == null ? void 0 : u24.id, onClick(d14) {
    o22 && (m4(d14.currentTarget) && d14.preventDefault(), o22.click(), o22.focus({ preventScroll: true }));
  } } }, import_react113.default.createElement(E14.Provider, { value: p12 }, c18({ ourProps: y11, theirProps: S10, slot: {}, defaultTag: ge7, name: "Switch.Group" }))));
}
var xe2 = "button";
function Ce2(n17, o22) {
  var L9;
  let s17 = (0, import_react51.useId)(), h11 = u4(), b11 = a3(), { id: T15 = h11 || `headlessui-switch-${s17}`, disabled: t13 = b11 || false, checked: p12, defaultChecked: y11, onChange: S10, name: c18, value: u24, form: d14, autoFocus: m11 = false, ...F12 } = n17, _10 = (0, import_react113.useContext)(E14), [H13, k8] = (0, import_react113.useState)(null), M9 = (0, import_react113.useRef)(null), U6 = y(M9, o22, _10 === null ? null : _10.setSwitch, k8), l16 = l2(y11), [a27, r20] = T(p12, S10, l16 != null ? l16 : false), I8 = p(), [P7, D8] = (0, import_react113.useState)(false), g8 = o5(() => {
  ...
  }), O8 = o5((e8) => e8.preventDefault()), W2 = N(), N2 = U2(), { isFocusVisible: v6, focusProps: J7 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: m11 }), { isHovered: x13, hoverProps: V6 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: t13 }), { pressed: C13, pressProps: X4 } = w({ disabled: t13 }), j10 = (0, import_react113.useMemo)(() => ({ checked: a27, disabled: t13, hover: x13, focus: v6, active: C13, autofocus: m11, changing: P7 }), [a27, x13, v6, C13, t13, P7, m11]), $7 = _({ id: T15, ref: U6, role: "switch", type: e5(n17, H13), tabIndex: n17.tabIndex === -1 ? 0 : (L9 = n17.tabIndex) != null ? L9 : 0, "aria-checked": a27, "aria-labelledby": W2, "aria-describedby": N2, disabled: t13 || void 0, autoFocus: m11, onClick: B4, onKeyUp: K6, onKeyPress: O8 }, J7, V6, X4), q5 = (0, import_react113.useCallback)(() => {
    if (l16 !== void 0)
      return r20 == null ? void 0 : r20(l16);
  }, [r20, l16]), z5 = L();
  return import_react113.default.createElement(import_react113.default.Fragment, null, c18 != null && import_react113.default.createElement(j2, { disabled: t13, data: { [c18]: u24 || "on" }, overrides: { type: "checkbox", checked: a27 }, form: d14, onReset: q5 }), z5({ ourProps: $7, theirProps: F12, slot: j10, defaultTag: xe2, name: "Switch" }));
}
var Le2 = K(Ce2);
var Re4 = ve;
var Ge3 = V;
var Ae5 = H4;
var Ze = Object.assign(Le2, { Group: Re4, Label: Ge3, Description: Ae5 });
...
function b10({ onFocus: n17 }) {
  let [r20, o22] = (0, import_react114.useState)(true), u24 = f19();
  return r20 ? import_react114.default.createElement(f4, { as: "button", type: "button", features: s4.Focusable, onFocus: (a27) => {
    ...
    function t13() {
      ...
      if (n17()) {
        if (cancelAnimationFrame(e8), !u24.current)
          return;
        o22(false);
        return;
      }
...
// node_modules/@headlessui/react/dist/components/tabs/tabs.js
var Le3 = ((t13) => (t13[t13.Forwards = 0] = "Forwards", t13[t13.Backwards = 1] = "Backwards", t13))(Le3 || {});
var _e3 = ((l16) => (l16[l16.Less = -1] = "Less", l16[l16.Equal = 0] = "Equal", l16[l16.Greater = 1] = "Greater", l16))(_e3 || {});
...
var Q4 = (0, import_react115.createContext)(null);
Q4.displayName = "TabsActionsContext";
function Y2(e8) {
  let r20 = (0, import_react115.useContext)(Q4);
  if (r20 === null) {
    let t13 = new Error(`<${e8} /> is missing a parent <Tab.Group /> component.`);
...
function he2(e8, r20) {
  ...
  let d14 = s17 !== null, u24 = s3({ isControlled: d14 }), T15 = y(r20), [p12, c18] = (0, import_react115.useReducer)(Fe6, { info: u24, selectedIndex: s17 != null ? s17 : t13, tabs: [], panels: [] }), h11 = (0, import_react115.useMemo)(() => ({ selectedIndex: p12.selectedIndex }), [p12.selectedIndex]), m11 = s3(n17 || (() => {
  })), M9 = s3(p12.tabs), S10 = (0, import_react115.useMemo)(() => ({ orientation: b11, activation: f24, ...p12 }), [b11, f24, p12]), P7 = o5((i18) => (c18({ type: 1, tab: i18 }), () => c18({ type: 2, tab: i18 }))), A6 = o5((i18) => (c18({ type: 3, panel: i18 }), () => c18({ type: 4, panel: i18 }))), E16 = o5((i18) => {
    _10.current !== i18 && m11.current(i18), d14 || c18({ type: 0, index: i18 });
  }), _10 = s3(d14 ? e8.selectedIndex : p12.selectedIndex), D8 = (0, import_react115.useMemo)(() => ({ registerTab: P7, registerPanel: A6, change: E16 }), []);
  n(() => {
    c18({ type: 0, index: s17 != null ? s17 : t13 });
  }, [s17]), n(() => {
    if (_10.current === void 0 || p12.tabs.length <= 0)
      return;
    let i18 = P5(p12.tabs, (R6) => R6.current);
    i18.some((R6, X4) => p12.tabs[X4] !== R6) && E16(i18.indexOf(p12.tabs[_10.current]));
  });
  let K6 = { ref: T15 }, J7 = L();
  return import_react115.default.createElement(f23, null, import_react115.default.createElement(Q4.Provider, { value: D8 }, import_react115.default.createElement(V5.Provider, { value: S10 }, S10.tabs.length <= 0 && import_react115.default.createElement(b10, { onFocus: () => {
    var i18, G6;
    for (let R6 of M9.current)
      if (((i18 = R6.current) == null ? void 0 : i18.tabIndex) === 0)
        return (G6 = R6.current) == null || G6.focus(), true;
    return false;
  } }), J7({ ourProps: K6, theirProps: g8, slot: h11, defaultTag: Ie4, name: "Tabs" }))));
}
var ve2 = "div";
function Ce3(e8, r20) {
...
function Ge4(e8, r20) {
  var ee5, te4;
  let t13 = (0, import_react51.useId)(), { id: l16 = `headlessui-tabs-tab-${t13}`, disabled: a27 = false, autoFocus: n17 = false, ...s17 } = e8, { orientation: g8, activation: b11, selectedIndex: f24, tabs: d14, panels: u24 } = C12("Tab"), T15 = Y2("Tab"), p12 = C12("Tab"), [c18, h11] = (0, import_react115.useState)(null), m11 = (0, import_react115.useRef)(null), M9 = y(m11, r20, h11);
  n(() => T15.registerTab(m11), [T15, m11]);
  let S10 = C11("tabs"), P7 = d14.indexOf(m11);
  P7 === -1 && (P7 = S10);
  let A6 = P7 === f24, E16 = o5((o22) => {
    var $7;
    let L9 = o22();
    if (L9 === y6.Success && b11 === "auto") {
      let q5 = ($7 = o2(m11)) == null ? void 0 : $7.activeElement, re4 = p12.tabs.findIndex((ce3) => ce3.current === q5);
      re4 !== -1 && T15.change(re4);
    }
    return L9;
  }), _10 = o5((o22) => {
    let L9 = d14.map((q5) => q5.current).filter(Boolean);
    ...
    switch (o22.key) {
      case o10.Home:
      case o10.PageUp:
        return o22.preventDefault(), o22.stopPropagation(), E16(() => g2(L9, T5.First));
      case o10.End:
      case o10.PageDown:
        return o22.preventDefault(), o22.stopPropagation(), E16(() => g2(L9, T5.Last));
    }
    if (E16(() => u(g8, { vertical() {
      return o22.key === o10.ArrowUp ? g2(L9, T5.Previous | T5.WrapAround) : o22.key === o10.ArrowDown ? g2(L9, T5.Next | T5.WrapAround) : y6.Error;
    }, horizontal() {
      return o22.key === o10.ArrowLeft ? g2(L9, T5.Previous | T5.WrapAround) : o22.key === o10.ArrowRight ? g2(L9, T5.Next | T5.WrapAround) : y6.Error;
    } })) === y6.Success)
      return o22.preventDefault();
    ...
    o22.preventDefault();
  }), { isFocusVisible: i18, focusProps: G6 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: n17 }), { isHovered: R6, hoverProps: X4 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: a27 }), { pressed: Z5, pressProps: ue5 } = w({ disabled: a27 }), Te6 = (0, import_react115.useMemo)(() => ({ selected: A6, hover: R6, active: Z5, focus: i18, autofocus: n17, disabled: a27 }), [A6, R6, i18, Z5, n17, a27]), de6 = _({ ref: M9, onKeyDown: _10, onMouseDown: J7, onClick: K6, id: l16, role: "tab", type: e5(e8, c18), "aria-controls": (te4 = (ee5 = u24[P7]) == null ? void 0 : ee5.current) == null ? void 0 : te4.id, "aria-selected": A6, tabIndex: A6 ? 0 : -1, disabled: a27 || void 0, autoFocus: n17 }, G6, X4, ue5);
...
function Ne3(e8, r20) {
  var A6, E16, _10, D8;
  let t13 = (0, import_react51.useId)(), { id: l16 = `headlessui-tabs-panel-${t13}`, tabIndex: a27 = 0, ...n17 } = e8, { selectedIndex: s17, tabs: g8, panels: b11 } = C12("Tab.Panel"), f24 = Y2("Tab.Panel"), d14 = (0, import_react115.useRef)(null), u24 = y(d14, r20);
  n(() => f24.registerPanel(d14), [f24, d14]);
  let T15 = C11("panels"), p12 = b11.indexOf(d14);
  p12 === -1 && (p12 = T15);
  let c18 = p12 === s17, { isFocusVisible: h11, focusProps: m11 } = $f7dceffc5ad7768b$export$4e328f61c538687f(), M9 = (0, import_react115.useMemo)(() => ({ selected: c18, focus: h11 }), [c18, h11]), S10 = _({ ref: u24, id: l16, role: "tabpanel", "aria-labelledby": (E16 = (A6 = g8[p12]) == null ? void 0 : A6.current) == null ? void 0 : E16.id, tabIndex: c18 ? a27 : -1 }, m11), P7 = L();
...
function H12(s17, l16) {
  let i18 = (0, import_react51.useId)(), d14 = u4(), n17 = a3(), { id: p12 = d14 || `headlessui-textarea-${i18}`, disabled: e8 = n17 || false, autoFocus: r20 = false, invalid: a27 = false, ...T15 } = s17, f24 = N(), m11 = U2(), { isFocused: o22, focusProps: u24 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: r20 }), { isHovered: t13, hoverProps: b11 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e8 }), y11 = _({ ref: l16, id: p12, "aria-labelledby": f24, "aria-describedby": m11, "aria-invalid": a27 ? "true" : void 0, disabled: e8 || void 0, autoFocus: r20 }, u24, b11), x13 = (0, import_react116.useMemo)(() => ({ disabled: e8, invalid: a27, hover: t13, focus: o22, autofocus: r20 }), [e8, a27, t13, o22, r20]);
  return L()({ ourProps: y11, theirProps: T15, slot: x13, defaultTag: L8, name: "Textarea" });
}
var J6 = K(H12);
export {
  H2 as Button,
