...
import { Calendar, Search, Filter, Download, Eye, ArrowLeft, Bell, Settings } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Bandeau de titre */}
        <div className="bg-gradient-to-r from-green-600 via-green-600/80 to-green-600 border border-border/30 rounded-2xl p-6 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="flex-1 min-w-0 space-y-2 md:space-y-3">
              ...
              <p className="text-green-100 text-base md:text-lg leading-relaxed">
                Gérez vos notifications et alertes de marchés publics
              </p>
            </div>
            ...
            <Card className="border border-gray-300 bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="p-6">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-foreground mb-2">Aucune notification disponible</h3>
                  <p className="text-muted-foreground">
                    Vos notifications apparaîtront ici une fois qu'elles seront générées.
                  </p>
                </div>
              </CardContent>
            </Card>
